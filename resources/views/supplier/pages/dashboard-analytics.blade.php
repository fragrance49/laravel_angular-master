...
{{-- page style --}}
@section('page-styles')
<link rel="stylesheet" type="text/css" href="{{asset('assets/supplier/css/pages/dashboard-analytics.css')}}">
@endsection
              ...
              <ul class="widget-timeline mb-0">
                <li class="timeline-items timeline-icon-primary active">
                  ...
                  <div class="timeline-content">
                    <img src="{{asset('assets/supplier/images/icon/pdf.png')}}" alt="document" height="23" width="19"
...
<script src="{{asset('assets/supplier/js/scripts/pages/dashboard-analytics.js')}}"></script>
@endsection
