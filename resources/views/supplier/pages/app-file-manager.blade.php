...
{{-- page styles --}}
@section('page-styles')
<link rel="stylesheet" type="text/css" href="{{asset('assets/supplier/css/pages/app-file-manager.css')}}">
@endsection
{{-- sidebar included --}}
@include('supplier.pages.app-file-manager-sidebar')
        ...
        <div class="card border shadow-none mb-1 app-file-info">
          <div class="card-content">
            <div class="app-file-content-logo card-img-top">
              ...
              <img class="d-block mx-auto" src="{{asset('assets/supplier/images/icon/pdf.png')}}" height="38" width="30"
                alt="Card image cap">
            </div>
      ...
      <div class="col-md-3 col-6">
        <div class="card border shadow-none mb-1 app-file-info">
          <div class="card-content">
            <div class="app-file-content-logo card-img-top">
              <i class="bx bx-dots-vertical-rounded app-file-edit-icon d-block float-right"></i>
              <img class="d-block mx-auto" src="{{asset('assets/supplier/images/icon/psd.png')}}" height="38" width="30"
                alt="Card image cap">
            </div>
            <div class="card-body p-50">
      ...
      <div class="col-md-3 col-6">
        <div class="card border shadow-none mb-1 app-file-info">
          <div class="card-content">
            <div class="app-file-content-logo card-img-top">
              <i class="bx bx-dots-vertical-rounded app-file-edit-icon d-block float-right"></i>
              <img class="d-block mx-auto" src="{{asset('assets/supplier/images/icon/doc.png')}}" height="38" width="30"
                alt="Card image cap">
            </div>
            <div class="card-body p-50">
              <div class="app-file-content-details">
      ...
      <div class="col-md-3 col-6">
        <div class="card border shadow-none mb-1 app-file-info">
          <div class="card-content">
            <div class="app-file-content-logo card-img-top">
              <i class="bx bx-dots-vertical-rounded app-file-edit-icon d-block float-right"></i>
              <img class="d-block mx-auto" src="{{asset('assets/supplier/images/icon/sketch.png')}}" height="38" width="30"
                alt="Card image cap">
            </div>
            <div class="card-body p-50">
              <div class="app-file-content-details">
...
<script src="{{asset('assets/supplier/js/scripts/pages/app-file-manager.js')}}"></script>
@endsection
