...
{{-- page-styles --}}
@section('page-styles')
<link rel="stylesheet" type="text/css" href="{{asset('assets/supplier/css/pages/page-knowledge-base.css')}}">
@endsection
@section('content')
                ...
                <div class="card-body">
                  ...
                  <ul class="list-unstyled users-list m-0 d-flex align-items-center">
                    <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom" title="Trina Lynes" class="avatar pull-up">
                        <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-1.jpg')}}" alt="Avatar" height="30" width="30">
                    </li>
                    <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom" title="Lilian Nenez" class="avatar pull-up">
                        <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-2.jpg')}}" alt="Avatar" height="30" width="30">
                    </li>
            ...
            <a href="{{asset('page-knowledge-base/categories/question')}}">
              <div class="card-content">
                <div class="card-body">
                  ...
                  <ul class="list-unstyled users-list m-0  d-flex align-items-center">
                    <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom" title="Trina Lynes" class="avatar pull-up">
                        <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-3.jpg')}}" alt="Avatar" height="30" width="30">
                    </li>
                    <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom" title="Alberto Glotzbach" class="avatar pull-up">
                        <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-4.jpg')}}" alt="Avatar" height="30" width="30">
                    </li>
                    <li class="d-inline-block pl-50">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled users-list m-0  d-flex align-items-center">
                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                                    ...
                                    <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-5.jpg')}}"
                                        alt="Avatar" height="30" width="30">
                                </li>
                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                                    title="Alberto Glotzbach" class="avatar pull-up">
                                    <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-6.jpg')}}"
                                        alt="Avatar" height="30" width="30">
                                </li>
                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                                    title="Alberto Glotzbach" class="avatar pull-up">
                                    <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-7.jpg')}}"
                                        alt="Avatar" height="30" width="30">
                                </li>
                                <li class="d-inline-block pl-50">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled users-list m-0  d-flex align-items-center">
                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                                    ...
                                    <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-8.jpg')}}"
                                        alt="Avatar" height="30" width="30">
                                </li>
                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                                    title="Lilian Nenez" class="avatar pull-up">
                                    <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-9.jpg')}}"
                                        alt="Avatar" height="30" width="30">
                                </li>
                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                                    title="Alberto Glotzbach" class="avatar pull-up">
                                    <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-10.jpg')}}"
                                        alt="Avatar" height="30" width="30">
                                </li>
                                <li class="d-inline-block pl-50">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled users-list m-0  d-flex align-items-center">
                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                                    title="Trina Lynes" class="avatar pull-up">
                                    <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-11.jpg')}}"
                                        alt="Avatar" height="30" width="30">
                                </li>
                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                                    title="Lilian Nenez" class="avatar pull-up">
                                    <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-12.jpg')}}"
                                        alt="Avatar" height="30" width="30">
                                </li>
                                <li class="d-inline-block pl-50">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled users-list m-0  d-flex align-items-center">
                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                                    title="Trina Lynes" class="avatar pull-up">
                                    <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-13.jpg')}}"
                                        alt="Avatar" height="30" width="30">
                                </li>
                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                                    title="Alberto Glotzbach" class="avatar pull-up">
                                    <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-14.jpg')}}"
                                        alt="Avatar" height="30" width="30">
                                </li>
                                <li class="d-inline-block pl-50">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled users-list m-0  d-flex align-items-center">
                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                                    title="Trina Lynes" class="avatar pull-up">
                                    <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-15.jpg')}}"
                                        alt="Avatar" height="30" width="30">
                                </li>
                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                                    title="Lilian Nenez" class="avatar pull-up">
                                    <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-16.jpg')}}"
                                        alt="Avatar" height="30" width="30">
                                </li>
                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                                    title="Alberto Glotzbach" class="avatar pull-up">
                                    <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-17.jpg')}}"
                                        alt="Avatar" height="30" width="30">
                                </li>
                                <li class="d-inline-block pl-50">
                                    <p class="text-muted mb-0 font-small-3">+10 more</p>
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled users-list m-0  d-flex align-items-center">
                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                                    title="Trina Lynes" class="avatar pull-up">
                                    <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-18.jpg')}}"
                                        alt="Avatar" height="30" width="30">
                                </li>
                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                                    title="Lilian Nenez" class="avatar pull-up">
                                    <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-19.jpg')}}"
                                        alt="Avatar" height="30" width="30">
                                </li>
                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                                    title="Alberto Glotzbach" class="avatar pull-up">
                                    <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-20.jpg')}}"
                                        alt="Avatar" height="30" width="30">
                                </li>
                                <li class="d-inline-block pl-50">
                                    <p class="text-muted mb-0 font-small-3">+40 more</p>
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled users-list m-0  d-flex align-items-center">
                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                                    title="Trina Lynes" class="avatar pull-up">
                                    <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-21.jpg')}}"
                                        alt="Avatar" height="30" width="30">
                                </li>
                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                                    title="Lilian Nenez" class="avatar pull-up">
                                    <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-22.jpg')}}"
                                        alt="Avatar" height="30" width="30">
                                </li>
                                <li class="d-inline-block pl-50">
                                    <p class="text-muted mb-0 font-small-3">+10 more</p>
...
<script src="{{asset('assets/supplier/js/scripts/pages/page-knowledge-base.js')}}"></script>
@endsection
