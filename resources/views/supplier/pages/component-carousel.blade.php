            ...
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                  <img class="img-fluid" src="{{asset('assets/supplier/images/slider/02.jpg')}}" alt="First slide">
                </div>
                <div class="carousel-item">
                  <img class="img-fluid" src="{{asset('assets/supplier/images/slider/03.jpg')}}" alt="Second slide">
                </div>
                <div class="carousel-item">
                  <img class="img-fluid" src="{{asset('assets/supplier/images/slider/01.jpg')}}" alt="Third slide">
                </div>
              </div>
        ...
        <div class="card-content">
          <div class="card-body">
            ...
            <div id="carousel-example-caption" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                  <img class="img-fluid" src="{{asset('assets/supplier/images/slider/04.jpg')}}" alt="First slide">
                ...
                <div class="carousel-item">
                  <img class="img-fluid" src="{{asset('assets/supplier/images/slider/06.jpg')}}" alt="Second slide">
                  <div class="card-img-overlay bg-overlay">
                    <div class="carousel-caption d-none d-sm-block">
                ...
                <div class="carousel-item">
                  <img class="img-fluid" src="{{asset('assets/supplier/images/slider/05.jpg')}}" alt="Third slide">
                  <div class="card-img-overlay bg-overlay">
                    <div class="carousel-caption d-none d-sm-block">
          ...
          <div class="card-body">
            ...
            <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img src="{{asset('assets/supplier/images/slider/06.jpg')}}" class="img-fluid d-block w-100" alt="cf-img-1">
                </div>
                <div class="carousel-item">
                  <img src="{{asset('assets/supplier/images/slider/02.jpg')}}" class="img-fluid d-block w-100" alt="cf-img-2">
                </div>
                <div class="carousel-item">
                  <img src="{{asset('assets/supplier/images/slider/05.jpg')}}" class="img-fluid d-block w-100" alt="cf-img-3">
                </div>
              </div>
