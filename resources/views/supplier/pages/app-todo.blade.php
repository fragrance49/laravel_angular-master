...
{{-- page style --}}
@section('page-styles')
<link rel="stylesheet" type="text/css" href="{{asset('assets/supplier/css/pages/app-todo.css')}}">
@endsection
{{-- sidebar --}}
@include('supplier.pages.app-todo-sidebar')
{{-- page content --}}
@section('content')
          ...
          <li class="todo-item" data-name="John Doe">
            <div class="todo-title-wrapper d-flex justify-content-sm-between justify-content-end align-items-center">
              ...
              <div class="todo-item-action d-flex align-items-center">
                ...
                <div class="avatar ml-1">
                  <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-2.jpg')}}" alt="avatar" height="30"
                    width="30">
                </div>
          ...
          <li class="todo-item" data-name="Maria Garcia">
            <div class="todo-title-wrapper d-flex justify-content-sm-between justify-content-end align-items-center">
              ...
              <div class="todo-item-action d-flex align-items-center">
                ...
                <div class="avatar ml-1">
                  <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-4.jpg')}}" alt="avatar" height="30"
                    width="30">
                </div>
                <a class='todo-item-favorite ml-75 warning'><i class="bx bx-star bxs-star"></i></a>
                <a class='todo-item-delete ml-75'><i class="bx bx-trash"></i></a>
          ...
          <li class="todo-item" data-name="Jamesh Jackson">
            <div class="todo-title-wrapper d-flex justify-content-sm-between justify-content-end align-items-center">
              ...
              <div class="todo-item-action d-flex align-items-center">
                ...
                <div class="avatar ml-1">
                  <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-8.jpg')}}" alt="avatar" height="30"
                    width="30">
                </div>
                <a class='todo-item-favorite ml-75'><i class="bx bx-star"></i></a>
                <a class='todo-item-delete ml-75'><i class="bx bx-trash"></i></a>
          ...
          <li class="todo-item" data-name="Marry Smith">
            <div class="todo-title-wrapper d-flex justify-content-sm-between justify-content-end align-items-center">
              ...
              <div class="todo-item-action d-flex align-items-center">
                ...
                <div class="avatar ml-1">
                  <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-12.jpg')}}" alt="avatar" height="30"
                    width="30">
                </div>
                <a class='todo-item-favorite ml-75'><i class="bx bx-star"></i></a>
                <a class='todo-item-delete ml-75'><i class="bx bx-trash"></i></a>
          ...
          <li class="todo-item" data-name="Maria Garcia">
            <div class="todo-title-wrapper d-flex justify-content-sm-between justify-content-end align-items-center">
              ...
              <div class="todo-item-action d-flex align-items-center">
                ...
                <div class="avatar ml-1">
                  <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-13.jpg')}}" alt="avatar" height="30"
                    width="30">
                </div>
                <a class='todo-item-favorite ml-75'><i class="bx bx-star"></i></a>
                <a class='todo-item-delete ml-75'><i class="bx bx-trash"></i></a>
...
<script src="{{asset('assets/supplier/js/scripts/pages/app-todo.js')}}"></script>
@endsection
