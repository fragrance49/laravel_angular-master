        ...
        <div class="card-body">
          <div class="card-text">
            ...
            <blockquote class="blockquote pl-1 border-left-primary border-left-3">
              <div class="media">
                <div class="pr-1">
                  <img class="media-object img-xl" src="{{asset('assets/supplier/images/portrait/small/avatar-s-5.jpg')}}"
              ...
              <div class="media">
                <div class="pr-1">
                  <img class="media-object img-xl rounded-circle"
                    src="{{asset('assets/supplier/images/portrait/small/avatar-s-3.jpg')}}" alt="Generic placeholder image">
                </div>
                <div class="media-body">
                  Sometimes life is going to hit you in the head with a brick. Don't lose faith.
                </div>
