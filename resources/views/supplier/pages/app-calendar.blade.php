...
<link rel="stylesheet" type="text/css" href="{{asset('assets/supplier/vendors/css/calendars/tui-time-picker.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('assets/supplier/vendors/css/calendars/tui-date-picker.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('assets/supplier/vendors/css/calendars/tui-calendar.min.css')}}">
@endsection
{{-- page styles --}}
@section('page-styles')
<link rel="stylesheet" type="text/css" href="{{asset('assets/supplier/css/core/menu/menu-types/vertical-menu.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('assets/supplier/css/plugins/calendars/app-calendar.css')}}">
@endsection
{{-- main page content --}}
@section('content')
<!-- calendar Wrapper  -->
...
<script src="{{asset('assets/supplier/vendors/js/calendar/tui-code-snippet.min.js')}}"></script>
<script src="{{asset('assets/supplier/vendors/js/calendar/tui-dom.js')}}"></script>
<script src="{{asset('assets/supplier/vendors/js/calendar/tui-time-picker.min.js')}}"></script>
<script src="{{asset('assets/supplier/vendors/js/calendar/tui-date-picker.min.js')}}"></script>
<script src="{{asset('assets/supplier/vendors/js/extensions/moment.min.js')}}"></script>
<script src="{{asset('assets/supplier/vendors/js/calendar/chance.min.js')}}"></script>
<script src="{{asset('assets/supplier/vendors/js/calendar/tui-calendar.min.js')}}"></script>
@endsection

{{-- page scripts --}}
@section('page-scripts')
<script src="{{asset('assets/supplier/js/scripts/extensions/calendar/calendars-data.js')}}"></script>
<script src="{{asset('assets/supplier/js/scripts/extensions/calendar/schedules.js')}}"></script>
<script src="{{asset('assets/supplier/js/scripts/extensions/calendar/app-calendar.js')}}"></script>
@endsection
