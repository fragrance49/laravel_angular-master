...
<div class="chat-user-profile">
    <header class="chat-user-profile-header text-center border-bottom">
      ...
      <div class="my-2">
        <div class="avatar">
          <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-11.jpg')}}" alt="user_avatar" height="100" width="100">
        </div>
  ...
  <div class="chat-sidebar card">
    ...
    <div class="chat-sidebar-search">
      <div class="d-flex align-items-center">
        <div class="chat-sidebar-profile-toggle">
          <div class="avatar">
            <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-11.jpg')}}" alt="user_avatar" height="36" width="36">
          </div>
        </div>
    ...
    <div class="chat-sidebar-list-wrapper pt-2">
      ...
      <ul class="chat-sidebar-list">
        <li>
          <div class="d-flex align-items-center">
            <div class="avatar m-0 mr-50"><img src="{{asset('assets/supplier/images/portrait/small/avatar-s-26.jpg')}}" height="36"
        ...
        <li>
          <div class="d-flex align-items-center">
            <div class="avatar m-0 mr-50"><img src="{{asset('assets/supplier/images/portrait/small/avatar-s-7.jpg')}}" height="36"
                width="36" alt="sidebar user image">
      ...
      <ul class="chat-sidebar-list">
        <li>
          <div class="d-flex align-items-center">
            <div class="avatar m-0 mr-50"><img src="{{asset('assets/supplier/images/portrait/small/avatar-s-8.jpg')}}" height="36"
                width="36" alt="sidebar user image">
        ...
        <li>
          <div class="d-flex align-items-center">
            <div class="avatar m-0 mr-50"><img src="{{asset('assets/supplier/images/portrait/small/avatar-s-5.jpg')}}" height="36"
                width="36" alt="sidebar user image">
              <span class="avatar-status-online"></span>
            </div>
            <div class="chat-sidebar-name">
        ...
        <li>
          <div class="d-flex align-items-center">
            <div class="avatar m-0 mr-50"><img src="{{asset('assets/supplier/images/portrait/small/avatar-s-9.jpg')}}" height="36"
                width="36" alt="sidebar user image">
              <span class="avatar-status-busy"></span>
            </div>
            <div class="chat-sidebar-name">
        ...
        <li>
          <div class="d-flex align-items-center">
            <div class="avatar m-0 mr-50"><img src="{{asset('assets/supplier/images/portrait/small/avatar-s-14.jpg')}}" height="36"
                width="36" alt="sidebar user image">
              <span class="avatar-status-online"></span>
            </div>
            <div class="chat-sidebar-name">
        ...
        <li>
          <div class="d-flex align-items-center">
            <div class="avatar m-0 mr-50"><img src="{{asset('assets/supplier/images/portrait/small/avatar-s-3.jpg')}}" height="36"
                width="36" alt="sidebar user image">
              <span class="avatar-status-offline"></span>
            </div>
            <div class="chat-sidebar-name">
