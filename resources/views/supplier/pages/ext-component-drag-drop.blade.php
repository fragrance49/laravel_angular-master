...
{{-- page styles --}}
@section('page-styles')
<link rel="stylesheet" type="text/css" href="{{asset('assets/supplier/css/plugins/extensions/drag-and-drop.css')}}">
@endsection
          ...
          <div class="card-body">
            ...
            <ul class="list-group" id="basic-list-group">
              <li class="list-group-item">
                <div class="media">
                  <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-12.jpg')}}" class="rounded-circle mr-2"
              ...
              <li class="list-group-item">
                <div class="media">
                  <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-1.jpg')}}" class="rounded-circle mr-2"
                    alt="img-placeholder" height="50" width="50">
                  <div class="media-body">
              ...
              <li class="list-group-item">
                <div class="media">
                  <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-2.jpg')}}" class="rounded-circle mr-2"
                    alt="img-placeholder" height="50" width="50">
                  <div class="media-body">
              ...
              <li class="list-group-item">
                <div class="media">
                  <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-3.jpg')}}" class="rounded-circle mr-2"
                    alt="img-placeholder" height="50" width="50">
                  <div class="media-body">
              ...
              <li class="list-group-item">
                <div class="media">
                  <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-4.jpg')}}" class="rounded-circle mr-2"
                    alt="img-placeholder" height="50" width="50">
                  <div class="media-body">
...
<script src="{{asset('assets/supplier/js/scripts/extensions/drag-drop.js')}}"></script>
@endsection
