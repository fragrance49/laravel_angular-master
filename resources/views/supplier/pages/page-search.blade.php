...
<link rel="stylesheet" type="text/css" href="{{asset('assets/supplier/css/pages/search.css')}}">
@endsection
@section('content')
            ...
            <li class="media-list">
              <div class="media mb-1">
                <a href="https://twitter.com/pixinvents" class="pr-1" target="_blank">
                  <img src="{{asset('assets/supplier/images/pages/pixinvent.jpg')}}" alt="pixinvent" class="rounded-circle"
                    height="50" width="50">
                </a>
                ...
                <div class="slide-content">
                  <a href="https://www.youtube.com/watch?time_continue=8&v=Y2zBqYEJCdw" target="_blank"
                    ...
                    <div class="position-relative mb-1">
                      <img src="{{asset('assets/supplier/images/slider/apex.jpg')}}" alt="apex" class="card-img">
              ...
              <div class="swiper-slide rounded">
                <div class="slide-content">
                  <a href="https://www.youtube.com/watch?v=ik9Nf7idrXY" class="font-medium-1" target="_blank">
                    <div class="position-relative mb-1">
                      <img src="{{asset('assets/supplier/images/slider/materialize.jpg')}}" alt="materialize" class="card-img">
                      <div class="card-img-overlay overlay-dark rounded">
                        <div class="d-flex justify-content-center align-items-center h-100">
                          <i class="bx bx-play-circle font-large-2 text-center"></i>
                        </div>
              ...
              <div class="swiper-slide rounded">
                <div class="slide-content">
                  <a href="https://www.youtube.com/watch?v=e7QTyzx-lYE" class="font-medium-1" target="_blank">
                    <div class="position-relative mb-1">
                      <img src="{{asset('assets/supplier/images/slider/modern.jpg')}}" alt="modern" class="card-img">
                      <div class="card-img-overlay overlay-dark rounded">
                        <div class="d-flex justify-content-center align-items-center h-100">
                          <i class="bx bx-play-circle font-large-2 text-center"></i>
                        </div>
              ...
              <div class="swiper-slide rounded">
                <div class="slide-content">
                  <a href="https://www.youtube.com/watch?v=4irB7FBO3j8" class="font-medium-1" target="_blank">
                    <div class="position-relative mb-1">
                      <img src="{{asset('assets/supplier/images/slider/stack.jpg')}}" alt="stack" class="card-img">
                      <div class="card-img-overlay overlay-dark rounded">
                        <div class="d-flex justify-content-center align-items-center h-100">
                          <i class="bx bx-play-circle font-large-2 text-center"></i>
                        </div>
              ...
              <div class="swiper-slide rounded">
                <div class="slide-content">
                  <a href="https://www.youtube.com/watch?v=xBa6ma7F_VA" target="_blank" class="font-medium-1">
                    <div class="position-relative mb-1">
                      <img src="{{asset('assets/supplier/images/slider/vuesax.jpg')}}" alt="Vuexy" class="card-img">
                      <div class="card-img-overlay overlay-dark rounded">
                        <div class="d-flex justify-content-center align-items-center h-100">
                          <i class="bx bx-play-circle font-large-2 text-center"></i>
                        </div>
                ...
                <div class="row text-center">
                  <div class="col-lg-2 col-sm-4 col-6">
                    <div class="suggestion mb-lg-0 mb-1">
                      <a href="https://themeforest.net/item/apex-angular-4-bootstrap-admin-template/20774875"
                        target="_blank">
                        <img src="{{asset('assets/supplier/images/pages/1-apex.png')}}" alt="Image description" height="40"
                          width="40">
                  ...
                  <div class="col-lg-2 col-sm-4 col-6">
                    <div class="suggestion mb-lg-0 mb-1">
                      <a href="https://themeforest.net/item/apex-angular-4-bootstrap-admin-template/20774875"
                        target="_blank">
                        <img src="{{asset('assets/supplier/images/pages/2-stack.png')}}" alt="Image description" height="40"
                          width="40">
                  ...
                  <div class="col-lg-2 col-sm-4 col-6">
                    <div class="suggestion mb-lg-0 mb-1">
                      <a href="https://themeforest.net/item/apex-angular-4-bootstrap-admin-template/20774875"
                        target="_blank">
                        <img src="{{asset('assets/supplier/images/pages/3-convex.png')}}" alt="Image description" height="40"
                          width="40">
                  ...
                  <div class="col-lg-2 col-sm-4 col-6">
                    <div class="suggestion mb-lg-0 mb-1">
                      <a href="https://themeforest.net/item/apex-angular-4-bootstrap-admin-template/20774875"
                        target="_blank">
                        <img src="{{asset('assets/supplier/images/pages/4-materialize.png')}}" alt="Image description"
                          height="40" width="40">
                  ...
                  <div class="col-lg-2 col-sm-4 col-6">
                    <div class="suggestion mb-lg-0 mb-1">
                      <a href="https://themeforest.net/item/apex-angular-4-bootstrap-admin-template/20774875"
                        target="_blank">
                        <img src="{{asset('assets/supplier/images/pages/modern-thumbnail.png')}}" alt="Image description"
                          height="40" width="40">
                  ...
                  <div class="col-lg-2 col-sm-4 col-6">
                    <div class="suggestion mb-lg-0 mb-1">
                      <a href="https://themeforest.net/item/apex-angular-4-bootstrap-admin-template/20774875"
                        target="_blank">
                        <img src="{{asset('assets/supplier/images/pages/thumbnail.png')}}" alt="Image description" height="40"
                          width="40">
      ...
      <div class="card box-search">
        <div class="card-body">
          <div class="text-center">
            <img class="img-fluid rounded" src="{{asset('assets/supplier/images/pages/vuesax-banner.jpg')}}" alt="logo">
          </div>
...
<script src="{{asset('assets/supplier/js/scripts/pages/page-search.js')}}"></script>
@endsection
