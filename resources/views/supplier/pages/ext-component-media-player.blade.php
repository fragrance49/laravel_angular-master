...
<link rel="stylesheet" type="text/css" href="{{asset('assets/supplier/vendors/css/ui/plyr.css')}}">@endsection
...
<script src="{{asset('assets/supplier/vendors/js/ui/plyr.min.js')}}"></script>
@endsection
{{-- page scripts --}}
@section('page-scripts')
<script src="{{asset('assets/supplier/js/scripts/extensions/ext-component-media-player.js')}}"></script>
@endsection
