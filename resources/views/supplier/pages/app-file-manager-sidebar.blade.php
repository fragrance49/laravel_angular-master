      ...
      <div class="tab-content pl-0">
        <div class="tab-pane active" id="details" aria-labelledby="details-tab" role="tabpanel">
          <div class="border-bottom d-flex align-items-center flex-column pb-1">
            <img src="{{asset('assets/supplier/images/icon/pdf.png')}}" alt="PDF" height="42" width="35" class="my-1">
            ...
            <ul class="widget-timeline mb-0">
              <li class="timeline-items timeline-icon-success active">
                ...
                <div class="timeline-content">
                  <img src="{{asset('assets/supplier/images/icon/psd.png')}}" alt="PSD" height="30" width="25"
              ...
              <li class="timeline-items timeline-icon-info active">
                ...
                <div class="timeline-content">
                  <img src="{{asset('assets/supplier/images/icon/sketch.png')}}" alt="Sketch" height="30" width="25"
              ...
              <li class="timeline-items timeline-icon-danger active">
                ...
                <div class="timeline-content">
                  <img src="{{asset('assets/supplier/images/icon/pdf.png')}}" alt="document" height="30" width="25"
