...
<section id="content-types">
  <div class="row">
    <div class="col-xl-4 col-md-6 col-sm-12">
      <div class="card">
        <div class="card-content">
          ...
          <img class="img-fluid" src="{{asset('assets/supplier/images/slider/11.png')}}" alt="Card image cap">
        </div>
    ...
    <div class="col-xl-4 col-md-6 col-sm-12">
      <div class="card">
        <div class="card-content">
          <img src="{{asset('assets/supplier/images/slider/10.png')}}" class="card-img-top img-fluid" alt="singleminded">
          <div class="card-body">
          ...
          <div id="carousel-example-card" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner rounded-0" role="listbox">
              <div class="carousel-item active">
                <img src="{{asset('assets/supplier/images/slider/01.jpg')}}" class="d-block w-100" alt="First slide">
              </div>
              <div class="carousel-item">
                <img src="{{asset('assets/supplier/images/slider/02.jpg')}}" class="d-block w-100" alt="Second slide">
              </div>
              <div class="carousel-item">
                <img src="{{asset('assets/supplier/images/slider/03.jpg')}}" class="d-block w-100" alt="Third slide">
              </div>
            </div>
    ...
    <div class="col-md-6 col-sm-12">
      <div class="card">
        <div class="card-content">
          <img class="card-img-top img-fluid" src="{{asset('assets/supplier/images/slider/05.jpg')}}" alt="Card image cap" />
          <div class="card-body">
    ...
    <div class="col-md-6 col-sm-12">
      <div class="card">
        <div class="card-content">
          ...
          <img class="card-img-bottom img-fluid" src="{{asset('assets/supplier/images/slider/06.jpg')}}" alt="Card image cap">
        </div>
      </div>
    </div>
  </div>
...
<section id="card-caps">
  <div class="row">
    <div class="col-xl-3 col-md-6 col-sm-12">
      <div class="card">
        <div class="card-content">
          <img class="card-img img-fluid" src="{{asset('assets/supplier/images/slider/08.jpg')}}" alt="Card image">
    ...
    <div class="col-xl-3 col-md-6 col-sm-12">
      <div class="card">
        <div class="card-content">
          <img class="card-img img-fluid" src="{{asset('assets/supplier/images/slider/07.jpg')}}" alt="Card image">
  ...
  <div class="row">
        ...
        <div class="card-content">
          <div class="row no-gutters">
            <div class="col-md-12 col-lg-4">
              <img src="{{asset('assets/supplier/images/banner/banner-35.jpg')}}" alt="element 01"
        ...
        <div class="card-content">
          <div class="row no-gutters">
            <div class="col-lg-4 col-md-12 d-flex align-items-center justify-content-center p-1">
              <img src="{{asset('assets/supplier/images/elements/apple-lap.png')}}" class="card-img img-fluid"
                alt="apple-lap.png">
            </div>
        ...
        <div class="card-content">
          <div class="row no-gutters">
            ...
            <div class="col-lg-4 col-12">
              <img src="{{asset('assets/supplier/images/banner/banner-30.jpg')}}" alt="element 01"
    ...
    <div class="col-xl-4 col-sm-6 col-12">
      <div class="card text-center bg-secondary bg-lighten-1">
        <div class="card-content text-white">
          <div class="card-body">
            <img src="{{asset('assets/supplier/images/elements/amazon-speaker.png')}}" alt="element 05" class="mb-1 w-100"
              height="200">
    ...
    <div class="col-xl-4 col-sm-6 col-12">
      <div class="card text-center">
        <div class="card-content">
          <div class="card-body">
            <img src="{{asset('assets/supplier/images/elements/beats-headphones.png')}}" alt="element 02" class="mb-1">
    ...
    <div class="col-xl-4 col-sm-6 col-12">
      <div class="card text-center bg-danger bg-lighten-2">
        <div class="card-content d-flex">
          <div class="card-body">
            <img src="{{asset('assets/supplier/images/elements/ipad-pro.png')}}" alt="element 06" height="150" class="mb-1">
            <h4 class="card-title white">New Arrival</h4>
  ...
  <div class="row match-height">
    <div class="col-12">
      <div class="card-group">
        <div class="card">
          <div class="card-content">
            <img class="card-img-top img-fluid" src="{{asset('assets/supplier/images/pages/content-img-3.jpg')}}"
              alt="Card image cap">
            <div class="card-body">
        ...
        <div class="card">
          <div class="card-content">
            <img class="card-img-top img-fluid" src="{{asset('assets/supplier/images/pages/content-img-2.jpg')}}"
              alt="Card image cap" />
            <div class="card-body">
              <h4 class="card-title">Card title</h4>
              <p class="card-text">
        ...
        <div class="card">
          <div class="card-content">
            <img class="card-img-top img-fluid" src="{{asset('assets/supplier/images/pages/content-img-4.jpg')}}"
              alt="Card image cap">
            <div class="card-body">
              <h4 class="card-title">Card title</h4>
              <p class="card-text">
        ...
        <div class="card">
          <div class="card-content">
            <img class="card-img-top img-fluid" src="{{asset('assets/supplier/images/pages/content-img-1.jpg')}}"
              alt="Card image cap">
            <div class="card-body">
              <h4 class="card-title">Card title</h4>
              <p class="card-text">
        ...
        <div class="card-deck">
          <div class="row no-gutters">
            <div class="col-md-3 col-sm-6 mb-sm-1">
              <div class="card">
                <div class="card-content">
                  <img class="card-img-top img-fluid" src="{{asset('assets/supplier/images/slider/01.jpg')}}"
                    alt="Card image cap" />
                  <div class="card-body">
                    <h4 class="card-title">Card title</h4>
                    <p class="card-text">
            ...
            <div class="col-md-3 col-sm-6 mb-sm-1">
              <div class="card">
                <div class="card-content">
                  <img class="card-img-top img-fluid" src="{{asset('assets/supplier/images/slider/04.jpg')}}"
                    alt="Card image cap" />
                  <div class="card-body">
                    <h4 class="card-title">Card title</h4>
                    <p class="card-text">
            ...
            <div class="col-md-3 col-sm-6">
              <div class="card">
                <div class="card-content">
                  <img class="card-img-top img-fluid" src="{{asset('assets/supplier/images/slider/05.jpg')}}"
                    alt="Card image cap" />
                  <div class="card-body">
                    <h4 class="card-title">Card title</h4>
                    <p class="card-text">
            ...
            <div class="col-md-3 col-sm-6">
              <div class="card">
                <div class="card-content">
                  <img class="card-img-top img-fluid" src="{{asset('assets/supplier/images/slider/06.jpg')}}"
                    alt="Card image cap" />
                  <div class="card-body">
                    <h4 class="card-title">Card title</h4>
                    <p class="card-text">
  ...
  <div class="row">
    <div class="col-md-12 mt-1">
      <div class="card-columns">
        <div class="card">
          <div class="card-content">
            <img class="card-img-top img-fluid" src="{{asset('assets/supplier/images/slider/09.png')}}" alt="Card image cap">
            <div class="card-body">
              <h4 class="card-title">Card title</h4>
              <p class="card-text">
        ...
        <div class="card bg-primary text-center">
          <div class="card-content">
            <div class="card-body">
              <img src="{{asset('assets/supplier/images/elements/iphone-x.png')}}" alt="element 05" width="150"
        ...
        <div class="card text-white bg-danger bg-lighten-1 text-center">
          <div class="card-content">
            <div class="card-body">
              <img src="{{asset('assets/supplier/images/elements/ipad-pro.png')}}" alt="element 02" width="120"
                class="mb-1 img-fluid">
        ...
        <div class="card">
          <div class="card-content">
            ...
            <img class="card-img-bottom img-fluid" src="{{asset('assets/supplier/images/slider/04.jpg')}}" alt="Card image cap">
          </div>
        </div>
        <div class="card text-white">
          <div class="card-content">
            <img class="card-img img-fluid" src="{{asset('assets/supplier/images/slider/03.jpg')}}" alt="Card image">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-md-6 col-sm-12 mb-50 d-flex justify-content-center">
                  <img src="{{asset('assets/supplier/images/elements/macbook-pro.png')}}" alt="element 04" width="150"
