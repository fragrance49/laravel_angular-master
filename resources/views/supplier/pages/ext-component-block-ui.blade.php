...
<script src="{{asset('assets/supplier/vendors/js/ui/blockUI.min.js')}}"></script>
@endsection
{{-- page scripts --}}
@section('page-scripts')
<script src="{{asset('assets/supplier/js/scripts/extensions/ext-component-block-ui.js')}}"></script>
@endsection
