                        ...
                        <div id="kb-carousel" class="carousel slide my-2" data-ride="carousel">
                            ...
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item active">
                                    <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-1.jpg')}}"
                                        alt="banner">
                                </div>
                                <div class="carousel-item">
                                    <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-2.jpg')}}"
                                        alt="banner">
                                </div>
                                <div class="carousel-item">
                                    <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-4.jpg')}}"
                                        alt="banner">
                                </div>
                            </div>
