...
{{-- page styles --}}
@section('page-styles')
<link rel="stylesheet" type="text/css" href="{{asset('assets/supplier/css/pages/app-chat.css')}}">
@endsection

{{-- page content --}}
@include('supplier.pages.app-chat-sidebar')
@section('content')
<!-- app chat overlay -->
      ...
      <header class="d-flex justify-content-between align-items-center border-bottom px-1 py-75">
        <div class="d-flex align-items-center">
          ...
          <div class="avatar chat-profile-toggle m-0 mr-1">
            <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-26.jpg')}}" alt="avatar" height="36" width="36" />
          ...
          <div class="chat-content">
            <div class="chat">
              <div class="chat-avatar">
                <a class="avatar m-0">
                  <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-11.jpg')}}" alt="avatar" height="36"
                    width="36" />
                </a>
              </div>
              <div class="chat-body">
            ...
            <div class="chat chat-left">
              <div class="chat-avatar">
                <a class="avatar m-0">
                  <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-26.jpg')}}" alt="avatar" height="36"
                    width="36" />
                </a>
              </div>
              <div class="chat-body">
...
<section class="chat-profile">
  <header class="chat-profile-header text-center border-bottom">
    ...
    <div class="my-2">
      <div class="avatar">
        <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-26.jpg')}}" alt="chat avatar" height="100" width="100">
      </div>
...
<script src="{{asset('assets/supplier/js/scripts/pages/app-chat.js')}}"></script>
@endsection
