...
<link rel="stylesheet" type="text/css" href="{{asset('assets/supplier/vendors/css/extensions/jquery.contextMenu.min.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('assets/supplier/vendors/css/extensions/toastr.css')}}">
@endsection
{{-- page styles --}}
@section('page-styles')
<link rel="stylesheet" type="text/css" href="{{asset('assets/supplier/css/plugins/extensions/toastr.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('assets/supplier/css/plugins/extensions/context-menu.css')}}">
@endsection
@section('content')
...
<script src="{{asset('assets/supplier/vendors/js/extensions/jquery.contextMenu.min.js')}}"></script>
<script src="{{asset('assets/supplier/vendors/js/extensions/toastr.min.js')}}"></script>
<script src="{{asset('assets/supplier/vendors/js/extensions/idle-timer.min.js')}}"></script>
<script src="{{asset('assets/supplier/vendors/js/extensions/moment.min.js')}}"></script>
<script src="{{asset('assets/supplier/vendors/js/extensions/numeral/numeral.js')}}"></script>
<script src="{{asset('assets/supplier/vendors/js/extensions/numeral/locales.js')}}"></script>
@endsection
{{-- page scripts --}}
@section('page-scripts')
<script src="{{asset('assets/supplier/js/scripts/extensions/ext-component-miscellaneous.js')}}"></script>
@endsection
