...
<link rel="stylesheet" type="text/css" href="{{asset('assets/supplier/vendors/css/extensions/nouislider.min.css')}}">
@endsection

{{-- page styles --}}
@section('page-styles')
<link rel="stylesheet" type="text/css" href="{{asset('assets/supplier/css/plugins/extensions/noui-slider.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('assets/supplier/css/core/colors/palette-noui.css')}}">
@endsection
...
<script src="{{asset('assets/supplier/vendors/js/extensions/wNumb.js')}}"></script>
<script src="{{asset('assets/supplier/vendors/js/extensions/nouislider.min.js')}}"></script>
@endsection
{{-- page scripts --}}
@section('page-scripts')
<script src="{{asset('assets/supplier/js/scripts/extensions/noui-slider.js')}}"></script>
@endsection
