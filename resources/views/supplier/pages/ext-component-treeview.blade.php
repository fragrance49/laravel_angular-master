...
<link rel="stylesheet" type="text/css" href="{{asset('assets/supplier/vendors/css/extensions/bootstrap-treeview.min.css')}}">
@endsection

{{-- page styles --}}
@section('page-styles')
<link rel="stylesheet" type="text/css" href="{{asset('assets/supplier/css/plugins/extensions/ext-component-treeview.css')}}">
@endsection
...
<script src="{{asset('assets/supplier/vendors/js/extensions/bootstrap-treeview.min.js')}}"></script>
@endsection
{{-- page scripts --}}
@section('page-scripts')
<script src="{{asset('assets/supplier/js/scripts/extensions/ext-component-treeview.js')}}"></script>
@endsection
