...
<link rel="stylesheet" type="text/css" href="{{asset('assets/supplier/vendors/css/jkanban/jkanban.min.css')}}">
...
{{-- page styles --}}
@section('page-styles')
<link rel="stylesheet" type="text/css" href="{{asset('assets/supplier/css/pages/app-kanban.css')}}">
@endsection
                ...
                <div class="form-group">
                  ...
                  <div class="d-flex align-items-center">
                    <div class="avatar m-0 mr-1">
                      <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-20.jpg')}}" height="36" width="36"
...
@section('vendor-scripts')
  <script src="{{asset('assets/supplier/vendors/js/jkanban/jkanban.min.js')}}"></script>
...
<script src="{{asset('assets/supplier/js/scripts/pages/app-kanban.js')}}"></script>
@endsection
