...
<link rel="stylesheet" type="text/css" href="{{asset('assets/supplier/css/plugins/forms/validation/form-validation.css')}}">
...
{{-- page styles --}}
@section('page-styles')
<link rel="stylesheet" type="text/css" href="{{asset('assets/supplier/css/pages/page-users.css')}}">
@endsection
        ...
        <div class="tab-content">
          <div class="tab-pane active fade show" id="account" aria-labelledby="account-tab" role="tabpanel">
            ...
            <div class="media mb-2">
                <a class="mr-2" href="#">
                    <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-26.jpg')}}" alt="users avatar"
...
<script src="{{asset('assets/supplier/vendors/js/forms/validation/jqBootstrapValidation.js')}}"></script>
...
<script src="{{asset('assets/supplier/js/scripts/pages/page-users.js')}}"></script>
<script src="{{asset('assets/supplier/js/scripts/navs/navs.js')}}"></script>
@endsection
