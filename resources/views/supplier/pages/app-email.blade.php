...
{{-- page styles --}}
@section('page-styles')
<link rel="stylesheet" type="text/css" href="{{asset('assets/supplier/css/pages/app-email.css')}}">
@endsection

{{-- sidebar page icluded --}}
@include('supplier.pages.app-email-sidebar')
      ...
      <div class="email-user-list list-group">
        <ul class="users-list-wrapper media-list">
          <li class="media mail-read">
            ...
            <div class="pr-50">
              <div class="avatar">
                <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-20.jpg')}}" alt="avtar img holder">
              </div>
            </div>
          ...
          <li class="media mail-read">
            ...
            <div class="pr-50">
              <div class="avatar">
                <img class="rounded-circle" src="{{asset('assets/supplier/images/portrait/small/avatar-s-17.jpg')}}"
          ...
          <li class="media">
            ...
            <div class="pr-50">
              <div class="avatar">
                <img class="rounded-circle" src="{{asset('assets/supplier/images/portrait/small/avatar-s-7.jpg')}}"
                  alt="Generic placeholder image">
              </div>
            </div>
            <div class="media-body">
          ...
          <li class="media">
            ...
            <div class="pr-50">
              <div class="avatar">
                <img class="rounded-circle" src="{{asset('assets/supplier/images/portrait/small/avatar-s-5.jpg')}}"
                  alt="Generic placeholder image">
              </div>
            </div>
            <div class="media-body">
          ...
          <li class="media mail-read">
            ...
            <div class="pr-50">
              <div class="avatar">
                <img class="rounded-circle" src="{{asset('assets/supplier/images/portrait/small/avatar-s-3.jpg')}}"
                  alt="Generic placeholder image">
              </div>
            </div>
            <div class="media-body">
          ...
          <li class="media mail-read">
            ...
            <div class="pr-50">
              <div class="avatar">
                <img class="rounded-circle" src="{{asset('assets/supplier/images/portrait/small/avatar-s-8.jpg')}}"
                  alt="Generic placeholder image">
              </div>
            </div>
            <div class="media-body">
          ...
          <li class="media">
            ...
            <div class="pr-50">
              <div class="avatar">
                <img class="rounded-circle" src="{{asset('assets/supplier/images/portrait/small/avatar-s-11.jpg')}}"
                  alt="Generic placeholder image">
              </div>
            </div>
            <div class="media-body">
          ...
          <li class="media mail-read">
            ...
            <div class="pr-50">
              <div class="avatar">
                <img class="rounded-circle" src="{{asset('assets/supplier/images/portrait/small/avatar-s-10.jpg')}}"
                  alt="Generic placeholder image">
              </div>
            </div>
            <div class="media-body">
          ...
          <li class="media mail-read">
            ...
            <div class="pr-50">
              <div class="avatar">
                <img class="rounded-circle" src="{{asset('assets/supplier/images/portrait/small/avatar-s-6.jpg')}}"
                  alt="Generic placeholder image">
              </div>
            </div>
            <div class="media-body">
          ...
          <li class="media">
            ...
            <div class="pr-50">
              <div class="avatar">
                <img class="rounded-circle" src="{{asset('assets/supplier/images/portrait/small/avatar-s-9.jpg')}}"
                  alt="Generic placeholder image">
              </div>
            </div>
            <div class="media-body">
          ...
          <li class="media">
            ...
            <div class="pr-50">
              <div class="avatar">
                <img class="rounded-circle" src="{{asset('assets/supplier/images/portrait/small/avatar-s-20.jpg')}}"
                  alt="Generic placeholder image">
              </div>
            </div>
            <div class="media-body">
                ...
                <div class="collapse-title media">
                  <div class="pr-1">
                    <div class="avatar mr-75">
                      <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-18.jpg')}}" alt="avtar img holder"
                        width="30" height="30">
                    </div>
                  </div>
                  ...
                  <div class="card-footer pt-0 border-top">
                    ...
                    <ul class="list-unstyled mb-0">
                      <li class="cursor-pointer pb-25">
                        <img src="{{asset('assets/supplier/images/icon/psd.png')}}" height="30" alt="psd.png">
                        <small class="text-muted ml-1 attchement-text">uikit-design.psd</small>
                      </li>
                      <li class="cursor-pointer">
                        <img src="{{asset('assets/supplier/images/icon/sketch.png')}}" height="30" alt="sketch.png">
            ...
            <div class="card collapse-header" role="tablist">
              <div id="headingCollapse6" class="card-header d-flex justify-content-between align-items-center"
                ...
                <div class="collapse-title media">
                  <div class="pr-1">
                    <div class="avatar mr-75">
                      <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-19.jpg')}}" alt="avtar img holder"
                        width="30" height="30">
                    </div>
                  </div>
                  <div class="media-body mt-25">
...
<script src="{{asset('assets/supplier/js/scripts/pages/app-email.js')}}"></script>
@endsection
