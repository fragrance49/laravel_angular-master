...
<link rel="stylesheet" type="text/css" href="{{asset('assets/supplier/vendors/css/forms/spinner/jquery.bootstrap-touchspin.css')}}">
@endsection
@section('content')
...
<script src="{{asset('assets/supplier/vendors/js/forms/spinner/jquery.bootstrap-touchspin.js')}}"></script>
@endsection
{{-- page scripts --}}
@section('page-scripts')
<script src="{{asset('assets/supplier/js/scripts/forms/number-input.js')}}"></script>
@endsection
