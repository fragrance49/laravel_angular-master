        ...
        <div class="card-content">
          <div class="card-body">
            ...
            <div class="media-list">
              <div class="media">
                <a class="pr-1" href="#">
                  <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-3.jpg')}}" alt="Generic placeholder image"
                    height="64" width="64" />
                </a>
              ...
              <div class="media">
                <a class="pr-1" href="#">
                  <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-6.jpg')}}" alt="Generic placeholder image"
                    height="64" width="64" />
                </a>
                <div class="media-body">
              ...
              <div class="media">
                <a class="pr-1" href="#">
                  <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-1.jpg')}}" alt="Generic placeholder image"
                    height="64" width="64" />
                </a>
                <div class="media-body">
                  <h4 class="media-heading">Tootsie roll dessert </h4>
              ...
              <div class="media">
                ...
                <a class="pl-1" href="#">
                  <img class="media-object rounded-circle"
                    src="{{asset('assets/supplier/images/portrait/small/avatar-s-10.jpg')}}" alt="Generic placeholder image"
                    height="64" width="64" />
                </a>
              </div>
              <div class="media">
                ...
                <a class="pl-1" href="#">
                  <img class="media-object rounded-circle"
                    src="{{asset('assets/supplier/images/portrait/small/avatar-s-7.jpg')}}" alt="Generic placeholder image"
                    height="64" width="64" />
                </a>
              </div>
              <div class="media">
                ...
                <a class="pl-1" href="#">
                  <img class="media-object rounded-circle"
                    src="{{asset('assets/supplier/images/portrait/small/avatar-s-2.jpg')}}" alt="Generic placeholder image"
                    height="64" width="64" />
                </a>
              </div>
            </div>
        ...
        <div class="card-content">
          <div class="card-body">
            ...
            <div class="media-list media-bordered">
              <div class="media">
                <a class="pr-1" href="#">
                  <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-23.jpg')}}" alt="Generic placeholder image"
                    height="64" width="64" />
                </a>
                <div class="media-body">
                  <h4 class="media-heading">Cookie candy</h4>
              ...
              <div class="media">
                <a class="pr-1" href="#">
                  <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-16.jpg')}}" alt="Generic placeholder image"
                    height="64" width="64" />
                </a>
                <div class="media-body">
                  <h4 class="media-heading">Tootsie roll dessert </h4>
              ...
              <div class="media">
                <a class="pr-1" href="#">
                  <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-15.jpg')}}" alt="Generic placeholder image"
                    height="64" width="64" />
                </a>
                <div class="media-body">
          ...
          <div class="card-body">
            ...
            <div class="media-list media-bordered">
              ...
              <div class="media">
                ...
                <a class="pl-1" href="#">
                  <img class="rounded-circle" src="{{asset('assets/supplier/images/portrait/small/avatar-s-14.jpg')}}"
                    alt="Generic placeholder image" height="64" width="64" />
                </a>
              </div>
              <div class="media">
                ...
                <a class="pl-1" href="#">
                  <img class="rounded-circle" src="{{asset('assets/supplier/images/portrait/small/avatar-s-21.jpg')}}"
                    alt="Generic placeholder image" height="64" width="64" />
                </a>
              </div>
            </div>
    ...
    <div class="col-sm-12">
      <div class="card">
        ...
        <div class="card-content">
          <div class="card-body">
            <div class="media">
              <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-12.jpg')}}" class="mr-1" alt="img placeholder"
                height="64" width="64">
              <div class="media-body">
                ...
                <div class="media mt-3">
                  <a class="mr-1" href="#">
                    <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-13.jpg')}}" alt="img placeholder"
                      height="64" width="64">
                  </a>
                  <div class="media-body">
                    <h5 class="mt-0">Media heading</h5>
            ...
            <div class="media-list media-bordered">
              <div class="media">
                <a class="align-self-start pr-1" href="#">
                  <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-4.jpg')}}" alt="Generic placeholder image"
                    height="64" width="64" />
                </a>
                <div class="media-body">
