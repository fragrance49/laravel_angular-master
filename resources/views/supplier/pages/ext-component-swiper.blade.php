...
{{-- page styles --}}
@section('page-styles')
<link rel="stylesheet" type="text/css" href="{{asset('assets/supplier/css/plugins/extensions/swiper.css')}}">
@endsection
        ...
        <div class="swiper-default swiper-container">
          <div class="swiper-wrapper">
            <div class="swiper-slide"> 
              <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-1.jpg')}}" alt="banner">
            </div>
            <div class="swiper-slide"> <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-2.jpg')}}" alt="banner">
            </div>
            <div class="swiper-slide"> <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-4.jpg')}}" alt="banner">
            </div>
            <div class="swiper-slide"> <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-13.jpg')}}" alt="banner">
            </div>
            <div class="swiper-slide"> <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-7.jpg')}}" alt="banner">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card-body">
        <div class="swiper-navigations swiper-container">
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide"> <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-14.jpg')}}" alt="banner">
            </div>
            <div class="swiper-slide"> <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-3.jpg')}}" alt="banner">
            </div>
            <div class="swiper-slide"> <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-2.jpg')}}" alt="banner">
            </div>
          </div>
    ...
    <div class="card-content">
      <div class="card-body">
        <div class="swiper-paginations swiper-container">
          <div class="swiper-wrapper">
            <div class="swiper-slide"> <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-12.jpg')}}" alt="banner">
            </div>
            <div class="swiper-slide"> <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-9.jpg')}}" alt="banner">
            </div>
            <div class="swiper-slide"> <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-8.jpg')}}" alt="banner">
            </div>
            <div class="swiper-slide"> <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-7.jpg')}}" alt="banner">
            </div>
            <div class="swiper-slide"> <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-20.jpg')}}" alt="banner">
            </div>
          </div>
          <!-- Add Pagination -->
      ...
      <div class="card-body">
        <div class="swiper-progress swiper-container">
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide"> <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-5.jpg')}}" alt="banner">
            </div>
            <div class="swiper-slide"> <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-4.jpg')}}" alt="banner">
            </div>
          </div>
    ...
    <div class="card-content">
      <div class="card-body">
        <div class="swiper-multiple swiper-container">
          <div class="swiper-wrapper">
            <div class="swiper-slide"> <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-31.jpg')}}" alt="banner">
            </div>
            <div class="swiper-slide"> <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-32.jpg')}}" alt="banner">
            </div>
            <div class="swiper-slide"> <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-33.jpg')}}" alt="banner">
            </div>
            <div class="swiper-slide"> <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-34.jpg')}}" alt="banner">
            </div>
            <div class="swiper-slide"> <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-35.jpg')}}" alt="banner">
            </div>
          </div>
          <!-- Add Pagination -->
          <div class="swiper-pagination"></div>
    ...
    <div class="card-content">
      <div class="card-body">
        <div class="swiper-multi-row swiper-container">
          <div class="swiper-wrapper">
              <div class="swiper-slide"> <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-26.jpg')}}" alt="banner">
              </div>
              <div class="swiper-slide"> <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-39.jpg')}}" alt="banner">
              </div>
              <div class="swiper-slide"> <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-28.jpg')}}" alt="banner">
              </div>
              <div class="swiper-slide"> <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-29.jpg')}}" alt="banner">
              </div>
              <div class="swiper-slide"> <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-30.jpg')}}" alt="banner">
              </div>
              <div class="swiper-slide"> <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-31.jpg')}}" alt="banner">
              </div>
              <div class="swiper-slide"> <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-32.jpg')}}" alt="banner">
        ...
        <div class="swiper-fade-effect swiper-container">
          <div class="swiper-wrapper">
            <div class="swiper-slide"> <img class="img-fluid"
                    src="{{asset('assets/supplier/images/banner/banner-20.jpg')}}" alt="banner">
            </div>
            <div class="swiper-slide"> <img class="img-fluid"
                    src="{{asset('assets/supplier/images/banner/banner-19.jpg')}}" alt="banner">
            </div>
            <div class="swiper-slide"> <img class="img-fluid"
                    src="{{asset('assets/supplier/images/banner/banner-18.jpg')}}" alt="banner">
            </div>
            <div class="swiper-slide"> <img class="img-fluid"
                    src="{{asset('assets/supplier/images/banner/banner-17.jpg')}}" alt="banner">
            </div>
            <div class="swiper-slide"> <img class="img-fluid"
                    src="{{asset('assets/supplier/images/banner/banner-16.jpg')}}" alt="banner">
            </div>
          </div>
          <!-- Add Pagination -->
    ...
    <div class="card-content">
      <div class="card-body">
        <div class="swiper-cube-effect swiper-container">
          <div class="swiper-wrapper">
            <div class="swiper-slide"> <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-21.jpg')}}" alt="banner">
            </div>
            <div class="swiper-slide"> <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-22.jpg')}}" alt="banner">
            </div>
            <div class="swiper-slide"> <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-23.jpg')}}" alt="banner">
            </div>
            <div class="swiper-slide"> <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-24.jpg')}}" alt="banner">
            </div>
          </div>
          <!-- Add Pagination -->
          <div class="swiper-pagination swiper-pagination-white"></div>
      ...
      <div class="card-body">
        <div class="swiper-coverflow swiper-container">
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide"> <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-38.jpg')}}" alt="banner">
            </div>
            <div class="swiper-slide"> <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-37.jpg')}}" alt="banner">
            </div>
            <div class="swiper-slide"> <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-36.jpg')}}" alt="banner">
            </div>
            <div class="swiper-slide"> <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-34.jpg')}}" alt="banner">
            </div>
            <div class="swiper-slide"> <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-33.jpg')}}" alt="banner">
      ...
      <div class="card-body">
        <div class="swiper-autoplay swiper-container">
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide"> <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-10.jpg')}}" alt="banner">
            </div>
            <div class="swiper-slide"> <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-11.jpg')}}" alt="banner">
            </div>
          </div>
          <!-- Add Pagination -->
          <div class="swiper-pagination"></div>
        ...
        <div class="card-body">
          <div class="swiper-gallery swiper-container gallery-top">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide"> <img class="img-fluid" src="{{asset('assets/supplier/images/banner/banner-15.jpg')}}" alt="banner">
                </div>
              </div>
              <!-- Add Arrows -->
              <div class="swiper-button-next"></div>
    ...
    <div class="card-content">
      <div class="card-body">
        ...
        <div class="swiper-parallax swiper-container">
          <div class="parallax-bg" data-swiper-parallax="-23%"><img class="img-fluid" src="{{asset('assets/supplier/images/banner/parallax-4.jpg')}}" alt="banner"> </div>
          <div class="swiper-wrapper">
            <div class="swiper-slide">
        ...
        <div class="swiper-lazy-loading swiper-container">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              ...
              <img src="{{asset('assets/supplier/images/banner/banner-9.jpg')}}" class="swiper-lazy img-fluid" alt="banner">
              <!-- Preloader image -->
              <div class="swiper-lazy-preloader swiper-lazy-preloader-white"></div>
            </div>
            <div class="swiper-slide">
              <img src="{{asset('assets/supplier/images/banner/banner-8.jpg')}}" class="swiper-lazy img-fluid" alt="banner">
              <div class="swiper-lazy-preloader swiper-lazy-preloader-white"></div>
            </div>
            <div class="swiper-slide">
              <img src="{{asset('assets/supplier/images/banner/banner-7.jpg')}}" class="swiper-lazy img-fluid" alt="banner">
              <div class="swiper-lazy-preloader swiper-lazy-preloader-white"></div>
            </div>
            <div class="swiper-slide">
              <img src="{{asset('assets/supplier/images/banner/banner-20.jpg')}}" class="swiper-lazy img-fluid" alt="banner">
              <div class="swiper-lazy-preloader swiper-lazy-preloader-white"></div>
            </div>
            <div class="swiper-slide">
              <img src="{{asset('assets/supplier/images/banner/banner-5.jpg')}}" class="swiper-lazy img-fluid" alt="banner">
              <div class="swiper-lazy-preloader swiper-lazy-preloader-white"></div>
            </div>
            <div class="swiper-slide">
              <img src="{{asset('assets/supplier/images/banner/banner-4.jpg')}}" class="swiper-lazy img-fluid" alt="banner">
              <div class="swiper-lazy-preloader swiper-lazy-preloader-white"></div>
            </div>
          </div>
...
<script src="{{asset('assets/supplier/js/scripts/extensions/swiper.js')}}"></script>
@endsection
