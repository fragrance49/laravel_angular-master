...
<script src="{{asset('assets/supplier/vendors/js/tables/datatable/dataTables.buttons.min.js')}}"></script>
<script src="{{asset('assets/supplier/vendors/js/tables/datatable/buttons.html5.min.js')}}"></script>
<script src="{{asset('assets/supplier/vendors/js/tables/datatable/buttons.print.min.js')}}"></script>
<script src="{{asset('assets/supplier/vendors/js/tables/datatable/buttons.bootstrap.min.js')}}"></script>
<script src="{{asset('assets/supplier/vendors/js/tables/datatable/pdfmake.min.js')}}"></script>
<script src="{{asset('assets/supplier/vendors/js/tables/datatable/vfs_fonts.js')}}"></script>
@endsection
{{-- page scripts --}}
@section('page-scripts')
<script src="{{asset('assets/supplier/js/scripts/datatables/datatable.js')}}"></script>
@endsection
