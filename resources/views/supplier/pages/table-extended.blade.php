...
<link rel="stylesheet" type="text/css" href="{{asset('assets/supplier/vendors/css/charts/apexcharts.css')}}">
      ...
      <table id="table-extended-transactions" class="table mb-0">
        ...
        <tbody>
          <tr>
            ...
            <td><img src="{{asset('assets/supplier/images/cards/amer-express.png')}}" class="mr-50" alt="card" height="25"
                width="35"> **** 7617</td>
            <td>10.09.17</td>
          ...
          <tr>
            ...
            <td><img src="{{asset('assets/supplier/images/cards/discover.png')}}" class="mr-50" alt="card" height="25"
                width="35"> **** 7617</td>
            <td>11.08.18</td>
          ...
          <tr>
            ...
            <td><img src="{{asset('assets/supplier/images/cards/mastercard.png')}}" class="mr-50" alt="card" height="25"
                width="35"> **** 7617</td>
            <td>11.08.18</td>
          ...
          <tr>
            <td><i class="bx bxs-circle success font-small-1 mr-50"></i><span>Paid</span></td>
            <td class="text-bold-600">Devin Payne</td>
            <td><img src="{{asset('assets/supplier/images/cards/visa.png')}}" class="mr-50" alt="card" height="25" width="35">
              **** 7617</td>
            <td>11.08.18</td>
            <td class="text-bold-600">$232</td>
          </tr>
  ...
  <div class="card">
    ...
    <div class="table-responsive">
      <table id="table-extended-success" class="table mb-0">
        ...
        <tbody>
          <tr>
            <td class="text-bold-600 pr-0"><img class="rounded-circle mr-1" src="{{asset('assets/supplier/images/cards/1.png')}}"
                alt="card">Headphones
              Beats</td>
          ...
          <tr>
            <td class="text-bold-600 pr-0"><img class="rounded-circle mr-1" src="{{asset('assets/supplier/images/cards/2.png')}}"
          ...
          <tr>
            <td class="text-bold-600 pr-0"><img class="rounded-circle mr-1" src="{{asset('assets/supplier/images/cards/3.png')}}"
                alt="card">Pepsi
              Drink
            </td>
            <td>Account number 4154 81** **** 7617</td>
          ...
          <tr>
            <td class="text-bold-600 pr-0"><img class="rounded-circle mr-1" src="{{asset('assets/supplier/images/cards/4.png')}}"
                alt="card">Headphones
              Beats</td>
            <td>Account number 4154 81** **** 7617</td>
            <td class="text-bold-600"><i class="text-bold-600 bx bx-music mr-50"></i><span>Music</span>
          ...
          <tr>
            <td class="text-bold-600 pr-0"><img class="rounded-circle mr-1" src="{{asset('assets/supplier/images/cards/5.png')}}"
                alt="card">Headphones
              Beats</td>
            <td>Account number 4154 81** **** 7617</td>
            <td class="text-bold-600"><i class="text-bold-600 bx bx-truck mr-50"></i><span>Transportation</span>
    ...
    <div class="table-responsive">
      <table id="table-extended-chechbox" class="table table-transparent">
        ...
        <tbody>
          <tr>
            <td></td>
            <td class="text-bold-600 pl-0"><img src="{{asset('assets/supplier/images/icon/pdf.png')}}" alt="file" class="mr-1"
                height="36" width="27">
              Music</td>
            <td>11/04/2019</td>
            <td>
              <ul class="list-unstyled users-list m-0  d-flex align-items-center">
                <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom" title="Lilian Nenez"
                  ...
                  <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-5.jpg')}}" alt="Avatar" height="30"
                    width="30">
                </li>
                <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom" title="Alberto Glotzbach"
                  class="avatar pull-up">
                  <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-6.jpg')}}" alt="Avatar" height="30"
                    width="30">
                </li>
                <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom" title="Alberto Glotzbach"
                  class="avatar pull-up">
                  <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-7.jpg')}}" alt="Avatar" height="30"
                    width="30">
                </li>
              </ul>
            </td>
          ...
          <tr>
            <td></td>
            <td class="text-bold-600 pl-0"><img src="{{asset('assets/supplier/images/icon/doc.png')}}" alt="file" class="mr-1"
            ...
            <td>
              <ul class="list-unstyled users-list m-0  d-flex align-items-center">
                <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom" title="Lilian Nenez"
                  class="avatar pull-up">
                  <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-1.jpg')}}" alt="Avatar" height="30"
                    width="30">
                </li>
                <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom" title="Alberto Glotzbach"
                  class="avatar pull-up">
                  <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-23.jpg')}}" alt="Avatar" height="30"
                    width="30">
                </li>
                <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom" title="Alberto Glotzbach"
                  class="avatar pull-up">
                  <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-3.jpg')}}" alt="Avatar" height="30"
                    width="30">
                </li>
              </ul>
            </td>
          ...
          <tr>
            <td></td>
            <td class="text-bold-600 pl-0"><img src="{{asset('assets/supplier/images/icon/sketch.png')}}" alt="file" class="mr-1"
            ...
            <td>
              <ul class="list-unstyled users-list m-0  d-flex align-items-center">
                <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom" title="Lilian Nenez"
                  class="avatar pull-up">
                  <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-10.jpg')}}" alt="Avatar" height="30"
                    width="30">
                </li>
                <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom" title="Alberto Glotzbach"
                  class="avatar pull-up">
                  <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-11.jpg')}}" alt="Avatar" height="30"
                    width="30">
                </li>
              </ul>
            </td>
          ...
          <tr>
            ...
            <td>
              <ul class="list-unstyled users-list m-0  d-flex align-items-center">
                <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom" title="Lilian Nenez"
                  class="avatar pull-up">
                  <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-20.jpg')}}" alt="Avatar" height="30"
                    width="30">
                </li>
                <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom" title="Alberto Glotzbach"
                  class="avatar pull-up">
                  <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-16.jpg')}}" alt="Avatar" height="30"
                    width="30">
                </li>
                <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom" title="Alberto Glotzbach"
                  class="avatar pull-up">
                  <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-17.jpg')}}" alt="Avatar" height="30"
                    width="30">
                </li>
                <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom" title="Alberto Glotzbach"
                  class="avatar pull-up">
          ...
          <tr>
            <td></td>
            <td class="text-bold-600 pl-0"><img src="{{asset('assets/supplier/images/icon/psd.png')}}" alt="file" class="mr-1"
          ...
          <table class="table mb-0">
            <tbody>
              <tr>
                <td>
                  <div class="d-flex align-items-center"><img class="rounded-circle mr-1"
                      src="{{asset('assets/supplier/images/cards/4.png')}}" height="32" width="32" alt="card">
              ...
              <tr>
                <td>
                  <div class="d-flex align-items-center"><img class="rounded-circle mr-1"
                      src="{{asset('assets/supplier/images/cards/6.png')}}" height="32" width="32" alt="card">
              ...
              <tr>
                <td>
                  <div class="d-flex align-items-center"><img class="rounded-circle mr-1"
                      src="{{asset('assets/supplier/images/cards/2.png')}}" height="32" width="32" alt="card">
              ...
              <tr>
                <td>
                  <div class="d-flex align-items-center"><img class="rounded-circle mr-1"
                      src="{{asset('assets/supplier/images/cards/1.png')}}" height="32" width="32" alt="card">
                    <div class="flex-content"><span class="font-medium-2">Beats</span><br><span
                        class="text-muted font-small-2">Music
                        Category</span></div>
                  </div>
          ...
          <table class="table table-borderless mb-0">
            <tbody>
              <tr>
                <td class="w-25 pr-0">
                  <div class="d-flex align-items-center text-bold-500"><img class="rounded-circle mr-1"
                      src="{{asset('assets/supplier/images/portrait/small/avatar-s-1.jpg')}}" alt="avatar" height="32"
                      width="32">
              ...
              <tr>
                <td class="w-25 pr-0">
                  <div class="d-flex align-items-center text-bold-500"><img class="rounded-circle mr-1"
                      src="{{asset('assets/supplier/images/portrait/small/avatar-s-2.jpg')}}" alt="avatar" height="32"
                      width="32">
              ...
              <tr>
                <td class="w-25 pr-0">
                  <div class="d-flex align-items-center text-bold-500"><img class="rounded-circle mr-1"
                      src="{{asset('assets/supplier/images/portrait/small/avatar-s-12.jpg')}}" alt="avatar" height="32"
                      width="32">
                    <div class="flex-content"> Steve White</div>
                  </div>
                </td>
              ...
              <tr>
                <td class="w-25 pr-0">
                  <div class="d-flex align-items-center text-bold-500"><img class="rounded-circle mr-1"
                      src="{{asset('assets/supplier/images/portrait/small/avatar-s-10.jpg')}}" alt="avatar" height="32"
                      width="32">
              ...
              <tr>
                <td>
                  <div class="d-flex align-items-center">
                    <img class="rounded-circle" src="{{asset('assets/supplier/images/portrait/small/avatar-s-1.jpg')}}"
    ...
    <div class="table-responsive">
      ...
      <table id="table-marketing-campaigns" class="table mb-0">
        ...
        <tbody>
          ...
          <tr>
            <td class="text-bold-600"><img class="rounded-circle mr-1" src="{{asset('assets/supplier/images/cards/1.png')}}"
                alt="card">Headphones
              Beats</td>
            <td>Account number 4154 81** **** 7617</td>
          ...
          <tr>
            <td class="text-bold-600"><img class="rounded-circle mr-1" src="{{asset('assets/supplier/images/cards/2.png')}}"
                alt="card">Nike Lab</td>
            <td>Account number 4154 81** **** 7617</td>
            <td class="text-bold-600"><i
          ...
          <tr>
            <td class="text-bold-600"><img class="rounded-circle mr-1" src="{{asset('assets/supplier/images/cards/3.png')}}"
          ...
          <tr>
            <td class="text-bold-600"><img class="rounded-circle mr-1" src="{{asset('assets/supplier/images/cards/4.png')}}"
                alt="card">Headphones
              Beats</td>
            <td>Account number 4154 81** **** 7617</td>
            <td class="text-bold-600"><i
          ...
          <tr>
            <td class="text-bold-600"><img class="rounded-circle mr-1" src="{{asset('assets/supplier/images/cards/5.png')}}"
                alt="card">Headphones
              Beats</td>
            <td>Account number 4154 81** **** 7617</td>
            <td class="text-bold-600"><i
...
<script src="{{asset('assets/supplier/vendors/js/tables/datatable/datatables.checkboxes.min.js')}}"></script>
<script src="{{asset('assets/supplier/vendors/js/charts/apexcharts.min.js')}}"></script>
...
<script src="{{asset('assets/supplier/js/scripts/pages/table-extended.js')}}"></script>
@endsection
