...
<link rel="stylesheet" type="text/css" href="{{asset('assets/supplier/vendors/css/charts/chartist.min.css')}}">
@endsection

{{-- page styles --}}
@section('page-styles')
<link rel="stylesheet" type="text/css" href="{{asset('assets/supplier/css/pages/chart-chartist.css')}}">
@endsection
...
<script src="{{asset('assets/supplier/vendors/js/charts/chartist.min.js')}}"></script>
@endsection
{{-- page scripts --}}
@section('page-scripts')
<script src="{{asset('assets/supplier/js/scripts/charts/chart-chartist.js')}}"></script>
@endsection
