...
<link rel="stylesheet" type="text/css" href="{{asset('assets/supplier/vendors/css/extensions/swiper.min.css')}}">
@endsection
{{-- page-styles --}}
@section('page-styles')
<link rel="stylesheet" type="text/css" href="{{asset('assets/supplier/css/pages/page-user-profile.css')}}">
@endsection
@section('content')
      ...
      <div class="card">
        <div class="card-content">
          <div class="user-profile-images">
            <!-- user timeline image -->
            <img src="{{asset('assets/supplier/images/profile/post-media/profile-banner.jpg')}}"
              class="img-fluid rounded-top user-timeline-image" alt="user timeline image">
            <!-- user profile image -->
            <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-16.jpg')}}" class="user-profile-image rounded"
              ...
              <div class="row">
                ...
                <div class="col-lg-4">
                  ...
                  <div class="card">
                    <div class="card-content">
                      <div class="card-body">
                        <h6><img src="{{asset('assets/supplier/images/profile/pages/pixinvent.jpg')}}" class="mr-25 round"
                            alt="logo" height="28">
                        ...
                        <div class="user-profile-event">
                          ...
                          <ul class="list-unstyled users-list d-flex align-items-center mt-1">
                            <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                              ...
                              <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-21.jpg')}}" alt="Avatar"
                                height="30" width="30">
                            </li>
                            <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                              title="Alberto Glotzbach" class="avatar pull-up">
                              <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-22.jpg')}}" alt="Avatar"
                                height="30" width="30">
                            </li>
                            <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                              title="Alberto Glotzbach" class="avatar pull-up">
                              <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-23.jpg')}}" alt="Avatar"
                                height="30" width="30">
                            </li>
                ...
                <div class="col-lg-8">
                              ...
                              <div class="col-12">
                                <div class="form-group row">
                                  <div class="col-sm-1 col-2">
                                    <div class="avatar">
                                      <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-2.jpg')}}"
                    ...
                    <div class="card-content">
                      <div class="card-header user-profile-header">
                        <div class="avatar mr-50 align-top">
                          <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-10.jpg')}}" alt="user avatar"
                            width="32" height="32">
                          <span class="avatar-status-online"></span>
                        </div>
                      ...
                      <div class="card-body py-0">
                        ...
                        <div class="d-flex border rounded">
                          <div class="user-profile-images"><img src="{{asset('assets/supplier/images/banner/banner-29.jpg')}}"
                        ...
                        <div class="user-profile-stories swiper-container pt-1">
                          <div class="swiper-wrapper user-profile-images">
                            <div class="swiper-slide">
                              <img src="{{asset('assets/supplier/images/profile/portraits/avatar-portrait-1.jpg')}}"
                            ...
                            <div class="swiper-slide">
                              <img src="{{asset('assets/supplier/images/profile/portraits/avatar-portrait-2.jpg')}}"
                                class="rounded user-profile-stories-image" alt="story image">
                              <div class="card-img-overlay bg-overlay">
                            ...
                            <div class="swiper-slide">
                              <img src="{{asset('assets/supplier/images/profile/portraits/avatar-portrait-3.jpg')}}"
                                class="rounded user-profile-stories-image" alt="story image">
                              <div class="card-img-overlay bg-overlay">
                            ...
                            <div class="swiper-slide">
                              <img src="{{asset('assets/supplier/images/profile/portraits/avatar-portrait-4.jpg')}}"
                                class="rounded user-profile-stories-image" alt="story image">
                              <div class="card-img-overlay bg-overlay">
                            ...
                            <div class="swiper-slide">
                              <img src="{{asset('assets/supplier/images/profile/portraits/avatar-portrait-5.jpg')}}"
                                class="rounded user-profile-stories-image" alt="story image">
                              <div class="card-img-overlay bg-overlay">
                  ...
                  <div class="card">
                    <div class="card-content">
                      <div class="card-header user-profile-header">
                        <div class="avatar mr-50 align-top">
                          <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-11.jpg')}}" alt="avtar image"
                            width="32" height="32">
                        ...
                        <div class="d-flex align-items-center">
                          ...
                          <div class="d-none d-sm-block">
                            <ul class="list-unstyled users-list m-0 d-flex align-items-center ml-1">
                              <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                                title="Lilian Nenez" class="avatar pull-up">
                                <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-24.jpg')}}" alt="Avatar"
                                  height="30" width="30">
                              </li>
                              <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                                title="Alberto Glotzbach" class="avatar pull-up">
                                <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-25.jpg')}}" alt="Avatar"
                                  height="30" width="30">
                              </li>
                              <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                                title="Alberto Glotzbach" class="avatar pull-up">
                                <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-26.jpg')}}" alt="Avatar"
                                  height="30" width="30">
                              </li>
                              <li class="d-inline-block pl-50">
                                <p class="text-muted mb-0 font-small-3">+10 more</p>
                    ...
                    <div class="card-header user-profile-header pt-0">
                      <div class="avatar mr-50 align-top">
                        <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-12.jpg')}}" alt="avtar image"
                          width="32" height="32">
                    ...
                    <div class="card-header user-profile-header pt-0">
                      <div class="avatar mr-50 align-top">
                        <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-13.jpg')}}" alt="avtar images"
                          width="32" height="32">
                    ...
                    <div class="form-group row align-items-center px-1">
                      <div class="col-2 col-sm-1">
                        <div class="avatar">
                          <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-2.jpg')}}" alt="avtar images"
                            width="32" height="32">
                          <span class="avatar-status-online"></span>
                        </div>
                      </div>
                  ...
                  <div class="card">
                    <div class="card-content">
                      <div class="card-header user-profile-header">
                        <div class="avatar mr-50 align-top">
                          <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-14.jpg')}}" alt="avtar images"
                            width="32" height="32">
                          <span class="avatar-status-online"></span>
                        </div>
                        <div class="d-inline-block mt-25">
                      ...
                      <div class="card-body py-0">
                        <p>To avoid winding up with a large bundle, it’s good to get ahead of the problem and use "Code
                          Splitting 🕹".</p>
                        <img src="{{asset('assets/supplier/images/profile/post-media/2.jpg')}}" alt="user image"
                          class="img-fluid">
                      </div>
                      <div class="card-footer d-flex justify-content-between pt-1">
                        <div class="d-flex align-items-center">
                          ...
                          <div class="d-none d-sm-block">
                            <ul class="list-unstyled users-list m-0 d-flex align-items-center ml-1">
                              <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                                title="Lilian Nenez" class="avatar pull-up">
                                <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-11.jpg')}}" alt="Avatar"
                                  height="30" width="30">
                              </li>
                              <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                                title="Alberto Glotzbach" class="avatar pull-up">
                                <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-12.jpg')}}" alt="Avatar"
                                  height="30" width="30">
                              </li>
                              <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                                title="Alberto Glotzbach" class="avatar pull-up">
                                <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-13.jpg')}}" alt="Avatar"
                                  height="30" width="30">
                              </li>
                              <li class="d-inline-block pl-50">
                                <p class="text-muted mb-0 font-small-3">+10 more</p>
                  ...
                  <div class="card">
                    <div class="card-content">
                      <div class="card-header user-profile-header">
                        <div class="avatar mr-50 align-top">
                          <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-18.jpg')}}" alt="avtar images"
                            width="32" height="32">
                          <span class="avatar-status-online"></span>
                        </div>
                        <div class="d-inline-block mt-25">
                  ...
                  <div class="card-body">
                    ...
                    <ul class="widget-timeline">
                      ...
                      <li class="timeline-items timeline-icon-primary active">
                        ...
                        <div class="timeline-content">
                          <img src="{{asset('assets/supplier/images/icon/sketch.png')}}" alt="document" height="36" width="27"
                      ...
                      <li class="timeline-items timeline-icon-danger active">
                        ...
                        <p class="timeline-text">on <a href="JavaScript:void(0);">Project name</a></p>
                        <div class="timeline-content">
                          <img src="{{asset('assets/supplier/images/icon/pdf.png')}}" alt="document" height="36" width="27"
                      ...
                      <div class="col-6">
                        <ul class="list-unstyled mb-0">
                          ...
                          <li class="media my-50">
                            <a href="JavaScript:void(0);">
                              <div class="avatar mr-1">
                                <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-3.jpg')}}" alt="avtar images"
                                  width="32" height="32">
                                <span class="avatar-status-offline"></span>
                              </div>
                            </a>
                          ...
                          <li class="media my-50">
                            <a href="JavaScript:void(0);">
                              <div class="avatar mr-1">
                                <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-4.jpg')}}" alt="avtar images"
                                  width="32" height="32">
                                <span class="avatar-status-busy"></span>
                              </div>
                            </a>
                          ...
                          <li class="media my-50">
                            <a href="JavaScript:void(0);">
                              <div class="avatar mr-1">
                                <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-5.jpg')}}" alt="avtar images"
                                  width="32" height="32">
                                <span class="avatar-status-busy"></span>
                              </div>
                            </a>
                      ...
                      <div class="col-6">
                        <ul class="list-unstyled mb-0">
                          <li class="media my-50">
                            <a href="JavaScript:void(0);">
                              <div class="avatar mr-1">
                                <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-16.jpg')}}" alt="avtar images"
                                  width="32" height="32">
                                <span class="avatar-status-offline"></span>
                              </div>
                            </a>
                          ...
                          <li class="media my-50">
                            <a href="JavaScript:void(0);">
                              <div class="avatar mr-1">
                                <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-7.jpg')}}" alt="avtar images"
                                  width="32" height="32">
                                <span class="avatar-status-busy"></span>
                              </div>
                            </a>
                          ...
                          <li class="media my-50">
                            <a href="JavaScript:void(0);">
                              <div class="avatar mr-1">
                                <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-8.jpg')}}" alt="avtar images"
                                  width="32" height="32">
                                <span class="avatar-status-online"></span>
                              </div>
                            </a>
                      ...
                      <div class="col-6">
                        <ul class="list-unstyled mb-0">
                          <li class="media my-50">
                            <a href="JavaScript:void(0);">
                              <div class="avatar mr-1">
                                <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-26.jpg')}}" alt="avtar images"
                                  width="32" height="32">
                                <span class="avatar-status-online"></span>
                              </div>
                            </a>
                          ...
                          <li class="media my-50">
                            <a href="JavaScript:void(0);">
                              <div class="avatar mr-1">
                                <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-25.jpg')}}" alt="avtar images"
                                  width="32" height="32">
                                <span class="avatar-status-offline"></span>
                              </div>
                            </a>
                          ...
                          <li class="media my-50">
                            <a href="JavaScript:void(0);">
                              <div class="avatar mr-1">
                                <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-24.jpg')}}" alt="avtar images"
                                  width="32" height="32">
                                <span class="avatar-status-busy"></span>
                              </div>
                            </a>
                      ...
                      <div class="col-6">
                        <ul class="list-unstyled mb-0">
                          <li class="media my-50">
                            <a href="JavaScript:void(0);">
                              <div class="avatar mr-1">
                                <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-23.jpg')}}" alt="avtar images"
                                  width="32" height="32">
                                <span class="avatar-status-busy"></span>
                              </div>
                            </a>
                          ...
                          <li class="media my-50">
                            <a href="JavaScript:void(0);">
                              <div class="avatar mr-1">
                                <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-22.jpg')}}" alt="avtar images"
                                  width="32" height="32">
                                <span class="avatar-status-away"></span>
                              </div>
                            </a>
                          ...
                          <li class="media my-50">
                            <a href="JavaScript:void(0);">
                              <div class="avatar mr-1">
                                <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-21.jpg')}}" alt="avtar images"
                                  width="32" height="32">
                                <span class="avatar-status-offline"></span>
                              </div>
                            </a>
                      ...
                      <div class="col-12">
                        <div class="row">
                          <div class="col-12 col-sm-3 text-center mb-1 mb-sm-0">
                            <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-16.jpg')}}" class="rounded"
              ...
              <div class="card-body">
                <div class="d-inline-flex">
                  <div class="avatar mr-50">
                    <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-20.jpg')}}" alt="avtar images" height="32"
                      width="32">
                  </div>
                ...
                <div class="user-profile-birthday-image text-center p-2">
                  <img class="img-fluid" src="{{asset('assets/supplier/images/profile/pages/birthday.png')}}" alt="image">
                </div>
            ...
            <div class="card-content">
              <div class="card-body">
                ...
                <div class="media d-flex align-items-center mb-1">
                  <a href="JavaScript:void(0);">
                    <img src="{{asset('assets/supplier/images/banner/banner-30.jpg')}}" class="rounded" alt="group image"
                      height="64" width="64" />
                  </a>
                ...
                <div class="media d-flex align-items-center mb-1">
                  <a href="JavaScript:void(0);">
                    <img src="{{asset('assets/supplier/images/banner/banner-31.jpg')}}" class="rounded" alt="group image"
                      height="64" width="64" />
                  </a>
                  <div class="media-body ml-1">
                ...
                <div class="media d-flex align-items-center">
                  <a href="JavaScript:void(0);">
                    <img src="{{asset('assets/supplier/images/banner/banner-32.jpg')}}" class="rounded" alt="group image"
                      height="64" width="64" />
                  </a>
                  <div class="media-body ml-1">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-md-4 col-6 pl-25 pr-0 pb-25">
                    <img src="{{asset('assets/supplier/images/profile/user-uploads/user-10.jpg')}}" class="img-fluid"
                      alt="gallery avtar img">
                  </div>
                  <div class="col-md-4 col-6 pl-25 pr-0 pb-25">
                    <img src="{{asset('assets/supplier/images/profile/user-uploads/user-11.jpg')}}" class="img-fluid"
                      alt="gallery avtar img">
                  </div>
                  <div class="col-md-4 col-6 pl-25 pr-0 pb-25">
                    <img src="{{asset('assets/supplier/images/profile/user-uploads/user-12.jpg')}}" class="img-fluid"
                      alt="gallery avtar img">
                  </div>
                  <div class="col-md-4 col-6 pl-25 pr-0 pb-25">
                    <img src="{{asset('assets/supplier/images/profile/user-uploads/user-13.jpg')}}" class="img-fluid"
                      alt="gallery avtar img">
                  </div>
                  <div class="col-md-4 col-6 pl-25 pr-0 pb-25">
                    <img src="{{asset('assets/supplier/images/profile/user-uploads/user-05.jpg')}}" class="img-fluid"
                      alt="gallery avtar img">
                  </div>
                  <div class="col-md-4 col-6 pl-25 pr-0 pb-25">
                    <img src="{{asset('assets/supplier/images/profile/user-uploads/user-06.jpg')}}" class="img-fluid"
                      alt="gallery avtar img">
                  </div>
                  <div class="col-md-4 col-6 pl-25 pr-0 pb-25">
                    <img src="{{asset('assets/supplier/images/profile/user-uploads/user-07.jpg')}}" class="img-fluid"
                      alt="gallery avtar img">
                  </div>
                  <div class="col-md-4 col-6 pl-25 pr-0 pb-25">
                    <img src="{{asset('assets/supplier/images/profile/user-uploads/user-08.jpg')}}" class="img-fluid"
                      alt="gallery avtar img">
                  </div>
                  <div class="col-md-4 col-6 pl-25 pr-0 pb-25">
                    <img src="{{asset('assets/supplier/images/profile/user-uploads/user-09.jpg')}}" class="img-fluid"
                      alt="gallery avtar img">
                  </div>
                </div>
              </div>
...
<script src="{{asset('assets/supplier/vendors/js/extensions/swiper.min.js')}}"></script>
@endsection
{{-- page scripts --}}
@section('page-scripts')
<script src="{{asset('assets/supplier/js/scripts/pages/page-user-profile.js')}}"></script>
@endsection
