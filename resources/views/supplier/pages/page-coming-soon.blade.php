@extends('supplier.layouts.fullLayoutMaster')
{{-- page title --}}
@section('title','Coming Soon')

{{-- page scripts --}}
@section('page-styles')
<link rel="stylesheet" type="text/css" href="{{asset('assets/supplier/css/pages/coming-soon.css')}}">
@endsection
...
<section>
  <div class="row flexbox-container">
    ...
    <div class="col-md-6 d-lg-block d-none p-2">
      <img class="img-fluid cs-effect cs-effect-bounce" src="{{asset('assets/supplier/images/pages/comingsoon.png')}}" alt="coming soon" width="650">
    </div>
  </div>
</section>
<!--/ coming soon end -->
...
<script src="{{asset('assets/supplier/vendors/js/coming-soon/jquery.countdown.min.js')}}"></script>
@endsection
{{-- page scripts --}}
@section('page-scripts')
<script src="{{asset('assets/supplier/js/scripts/pages/coming-soon.js')}}"></script>
@endsection
