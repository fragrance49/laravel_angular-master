...
<link rel="stylesheet" type="text/css" href="{{asset('assets/supplier/vendors/css/editors/quill/katex.min.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('assets/supplier/vendors/css/editors/quill/monokai-sublime.min.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('assets/supplier/vendors/css/editors/quill/quill.snow.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('assets/supplier/vendors/css/editors/quill/quill.bubble.css')}}">
@endsection
...
<script src="{{asset('assets/supplier/vendors/js/editors/quill/katex.min.js')}}"></script>
<script src="{{asset('assets/supplier/vendors/js/editors/quill/highlight.min.js')}}"></script>
...
<script src="{{asset('assets/supplier/js/scripts/editors/editor-quill.js')}}"></script>
@endsection
