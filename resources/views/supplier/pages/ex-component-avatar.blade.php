        ...
        <div class="card-content">
          <div class="card-body">
            ...
            <div class="avatar mr-1">
              <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-20.jpg')}}" alt="avtar img holder" height="32"
                width="32">
            </div>
          </div>
        </div>
      ...
      <div class="card">
        ...
        <div class="card-content">
          <div class="card-body">
            ...
            <div class="avatar mr-1">
              <img src="{{asset('assets/supplier/images/portrait/small/avatar-s-20.jpg')}}" alt="avtar img holder" width="32"
                height="32">
