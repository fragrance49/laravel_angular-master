...
@endsection
@section('page-styles')
<link rel="stylesheet" type="text/css" href="{{asset('assets/supplier/css/pages/dashboard-ecommerce.css')}}">
@endsection
            ...
            <div class="card-body">
              <div class="d-flex justify-content-between align-items-end">
                ...
                <div class="dashboard-content-right">
                  <img src="{{asset('assets/supplier/images/icon/cup.png')}}" height="220" width="220" class="img-fluid"
              ...
              <tbody>
                <tr>
                  <td class="py-1 line-ellipsis">
                    <img class="rounded-circle mr-1" src="{{asset('assets/supplier/images/icon/fs.png')}}" alt="card" height="24"
                ...
                <tr>
                  <td class="py-1 line-ellipsis">
                    <img class="rounded-circle mr-1" src="{{asset('assets/supplier/images/icon/puma.png')}}" alt="card" height="24"
                      width="24">Puma Shoes
                  </td>
                  <td class="py-1">
                ...
                <tr>
                  <td class="py-1 line-ellipsis">
                    <img class="rounded-circle mr-1" src="{{asset('assets/supplier/images/icon/nike.png')}}" alt="card" height="24"
                ...
                <tr>
                  <td class="py-1 line-ellipsis">
                    <img class="rounded-circle mr-1" src="{{asset('assets/supplier/images/icon/one-plus.png')}}" alt="card"
                ...
                <tr>
                  <td class="py-1 line-ellipsis">
                    <img class="rounded-circle mr-1" src="{{asset('assets/supplier/images/icon/google.png')}}" alt="card"
...
<script src="{{asset('assets/supplier/js/scripts/pages/dashboard-ecommerce.js')}}"></script>
@endsection
