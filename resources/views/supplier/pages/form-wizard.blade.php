...
{{-- page style --}}
@section('page-styles')
<link rel="stylesheet" type="text/css" href="{{asset('assets/supplier/css/plugins/forms/wizard.css')}}">
@endsection
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                      <div class="d-flex justify-content-between flex-wrap align-items-center">
                        <div class="vs-radio-con vs-radio-primary">
                          <img src="{{asset('assets/supplier/images/pages/bank.png')}}" alt="img-placeholder" height="40">
                  ...
                  <div class="col-12 d-flex">
                    <div class="paypal cursor-pointer d-flex align-items-center">
                      ...
                      <img src="{{asset('assets/supplier/images/pages/PayPal_logo.png')}}" alt="PayPal Logo">
                    </div>
                    <div class="googlepay cursor-pointer pl-1 d-flex align-items-center">
                      ...
                      <img src="{{asset('assets/supplier/images/pages/google-pay.png')}}" height="30" alt="google Logo">
                    </div>
                  </div>
...
<script src="{{asset('assets/supplier/js/scripts/forms/wizard-steps.js')}}"></script>
@endsection
