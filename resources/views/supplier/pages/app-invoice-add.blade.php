          ...
          <div class="card-body pb-0 mx-25">
            ...
            <div class="row my-2 py-50">
              ...
              <div class="col-sm-6 col-12 order-1 order-sm-1 d-flex justify-content-end">
                <img src="{{asset('assets/supplier/images/pages/pixinvent-logo.png')}}" alt="logo" height="46" width="164">
              </div>
            </div>
            <hr>
...
<script src="{{asset('assets/supplier/vendors/js/forms/repeater/jquery.repeater.min.js')}}"></script>
@endsection
{{-- page scripts --}}
