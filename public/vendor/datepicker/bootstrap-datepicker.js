...
! function(t, e) {
    ...
    function n(e, i) {
        function a(t, e) { return e.toLowerCase() }
        var s, n = t(e).data(),
            r = {},
    ...
    function r(e) { var i = {}; if (f[e] || (e = e.split("-")[0], f[e])) { var a = f[e]; return t.each(p, function(t, e) { e in a && (i[e] = a[e]) }), i } }
    var h = t(window),
        o = function() {
            var e = {
                ...
                copy: function() { var t = new o; return t.replace(this), t }
            };
            return function() { var i = []; return i.push.apply(i, arguments), t.extend(i, e), i }
        }(),
    ...
    d.prototype = {
        ...
        _process_options: function(e) {
            ...
            if (n = t.grep(n, function(t) { return /^auto|left|right|top|bottom$/.test(t) }), i.orientation = { x: "auto", y: "auto" }, r && "auto" !== r)
                if (1 === n.length) switch (n[0]) {
                    ...
                    case "right":
                        i.orientation.x = n[0]
                } else r = t.grep(n, function(t) { return /^left|right$/.test(t) }), i.orientation.x = r[0] || "auto", r = t.grep(n, function(t) { return /^top|bottom$/.test(t) }), i.orientation.y = r[0] || "auto";
                else;
        },
        _events: [],
        _secondaryEvents: [],
        _applyEvents: function(t) { for (var i, a, s, n = 0; n < t.length; n++) i = t[n][0], 2 === t[n].length ? (a = e, s = t[n][1]) : 3 === t[n].length && (a = t[n][1], s = t[n][2]), i.on(s, a) },
        _unapplyEvents: function(t) { for (var i, a, s, n = 0; n < t.length; n++) i = t[n][0], 2 === t[n].length ? (s = e, a = t[n][1]) : 3 === t[n].length && (s = t[n][1], a = t[n][2]), i.off(a, s) },
        ...
        _trigger: function(e, i) {
            ...
            this.element.trigger({ type: e, date: s, dates: t.map(this.dates, this._utc_to_local), format: t.proxy(function(t, e) { 0 === arguments.length ? (t = this.dates.length - 1, e = this.o.format) : "string" == typeof t && (e = t, t = this.dates.length - 1), e = e || this.o.format; var i = this.dates.get(t); return g.formatDate(i, e, this.o.language) }, this) })
        },
        ...
        hide: function() { this.isInline || this.picker.is(":visible") && (this.focusDate = null, this.picker.hide().detach(), this._detachSecondaryEvents(), this.viewMode = this.o.startView, this.showMode(), this.o.forceParse && (this.isInput && this.element.val() || this.hasInput && this.element.find("input").val()) && this.setValue(), this._trigger("hide")) },
        ...
        getDates: function() { return t.map(this.dates, this._utc_to_local) },
        getUTCDates: function() { return t.map(this.dates, function(t) { return new Date(t) }) },
        ...
        getFormattedDate: function(i) { i === e && (i = this.o.format); var a = this.o.language; return t.map(this.dates, function(t) { return g.formatDate(t, i, a) }).join(this.o.multidateSeparator) },
        ...
        fill: function() {
            ...
            n -= 1;
            for (var M, x = t.map(this.dates, function(t) { return t.getUTCFullYear() }), S = -1; 11 > S; S++) M = ["year"], -1 === S ? M.push("old") : 10 === S && M.push("new"), -1 !== t.inArray(n, x) && M.push("active"), (h > n || n > d) && M.push("disabled"), y += '<span class="' + M.join(" ") + '">' + n + "</span>", n += 1;
            U.html(y)
        },
        ...
        moveMonth: function(t, i) {
            ...
            var a, s, n = new Date(t.valueOf()),
                ...
                h = n.getUTCMonth(),
                o = Math.abs(i);
            if (i = i > 0 ? 1 : -1, 1 === o) s = -1 === i ? function() { return n.getUTCMonth() === h } : function() { return n.getUTCMonth() !== a }, a = h + i, n.setUTCMonth(a), (0 > a || a > 11) && (a = (a + 12) % 12);
            else {
    ...
    l.prototype = {
        updateDates: function() { this.dates = t.map(this.pickers, function(t) { return t.getUTCDate() }), this.updateRanges() },
    ...
    var f = t.fn.datepicker.dates = { en: { days: ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"], daysShort: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"], daysMin: ["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa", "Su"], months: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], monthsShort: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], today: "Today", clear: "Clear" } },
        g = {
            ...
            getDaysInMonth: function(t, e) { return [31, g.isLeapYear(t) ? 29 : 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31][e] },
            ...
            parseDate: function(a, s, n) {
                ...
                var w = s.parts.slice();
                if (u.length !== w.length && (w = t(w).filter(function(e, i) { return -1 !== t.inArray(i, m) }).toArray()), u.length === w.length) {
                    var k;
    ...
    g.template = '<div class="datepicker"><div class="datepicker-days"><table class=" table-condensed">' + g.headTemplate + "<tbody></tbody>" + g.footTemplate + '</table></div><div class="datepicker-months"><table class="table-condensed">' + g.headTemplate + g.contTemplate + g.footTemplate + '</table></div><div class="datepicker-years"><table class="table-condensed">' + g.headTemplate + g.contTemplate + g.footTemplate + "</table></div></div>", t.fn.datepicker.DPGlobal = g, t.fn.datepicker.noConflict = function() { return t.fn.datepicker = c, this }, t(document).on("focus.datepicker.data-api click.datepicker.data-api", '[data-provide="datepicker"]', function(e) {
        var i = t(this);
...
$val1 = $currenturl.includes("/villa/details");
// console.log('ggug'+$val1);
var availDates = '';
if ($val1) {
    availDates = available(nowTemp);
}

// Datepicker for Hotels
var checkinH = $('#dph1').datepicker({
    ...
    checkoutH.datepicker("setDate", newDate);
    if (ev.date.valueOf() > checkoutH.datepicker("getDate").valueOf() ||
        !checkoutH.datepicker("getDate").valueOf()) {
        checkoutH.datepicker("update", newDate);
    }
    $('#dph2')[0].focus();
});
var checkoutH = $('#dph2').datepicker({
    ...
    orientation: "left top",
    beforeShowDay: function(date) {
        return date.valueOf() > checkinH.datepicker("getDate").valueOf();
    },
    autoclose: true
}).on('changeDate', function(ev) {
...
var checkinV = $('#dpv1').datepicker({
    ...
    var newDate = new Date(ev.date);
    newDate.setDate(newDate.getDate() + 2);
    checkoutV.datepicker("setDate", newDate);
    if (ev.date.valueOf() > checkoutV.datepicker("getDate").valueOf() ||
        !checkoutV.datepicker("getDate").valueOf()) {
        checkoutV.datepicker("update", newDate);
    }
    $('#dpv2')[0].focus();
});
...
var checkoutV = $('#dpv2').datepicker({
    ...
    orientation: "left top",
    beforeShowDay: function(date) {
        return date.valueOf() > checkinV.datepicker("getDate").valueOf();
    },
    autoclose: true
}).on('changeDate', function(ev) {
    focusObj($(this).closest('form').find('.travellers-input-popup'), 'show');
...
var checkinT = $('#dpt1').datepicker({
    ...
    var newDate = new Date(ev.date);
    newDate.setDate(newDate.getDate() + 2);
    checkoutT.datepicker("setDate", newDate);
    if (ev.date.valueOf() > checkoutT.datepicker("getDate").valueOf() ||
        !checkoutT.datepicker("getDate").valueOf()) {
        checkoutT.datepicker("update", newDate);
    }
    $('#dpt2')[0].focus();
});
...
var checkoutT = $('#dpt2').datepicker({
    ...
    orientation: "left top",
    beforeShowDay: function(date) {
        return date.valueOf() > checkinT.datepicker("getDate").valueOf();
    },
    autoclose: true
}).on('changeDate', function(ev) {
    // focusObj($(this).closest('form').find('.travellers-input-popup'),'show');
...
var checkinR = $('#dpr1').datepicker({
    ...
    var newDate = new Date(ev.date);
    newDate.setDate(newDate.getDate() + 2);
    checkoutR.datepicker("setDate", newDate);
    if (ev.date.valueOf() > checkoutR.datepicker("getDate").valueOf() ||
        !checkoutR.datepicker("getDate").valueOf()) {
        checkoutR.datepicker("update", newDate);
    }
    $('#dpr2')[0].focus();
});
var checkoutR = $('#dpr2').datepicker({
    ...
    orientation: "left top",
    beforeShowDay: function(date) {
        return date.valueOf() > checkinR.datepicker("getDate").valueOf();
    },
    autoclose: true
}).on('changeDate', function(ev) {
    // focusObj($(this).closest('form').find('.travellers-input-popup'),'show');
...
var checkinVA = $('#dpvv1').datepicker({
    ...
    todayHighlight: true,
    forceParse: false,
    // datesDisabled: availDates,
    beforeShowDay: function(date) {
        // availDates
        if (availDates.length > 0) {
            var dmys = ('0' + date.getDate()).slice(-2) + '/' + ('0' + (date.getMonth() + 1)).slice(-2) + '/' + date.getFullYear();
            for (var i = 0; i < availDates.length; i++) {
                if (dmys == availDates[i]) {
                    // return false;
                    return {
    ...
    var newDate = new Date(ev.date);
    checkoutVA.datepicker("setStartDate", newDate);
    if (ev.date.valueOf() >= checkoutVA.datepicker("getDate").valueOf() ||
        !checkoutVA.datepicker("getDate").valueOf()) {
        if ($('input[name="price_type"]').val() == '2') {
            newDate.setDate(newDate.getDate() + 7);
            checkoutVA.datepicker("update", newDate);
        } else {
            if (ev.date.valueOf() >= checkoutVA.datepicker("getDate").valueOf()) {
    ...
    var endD1 = new Date(checkoutVA.datepicker("getDate"));
    rateCalc(startD1, endD1);
    $('#dpvv2')[0].focus();
});

// $depdate =  new Date($('input[name="departDate"]').val());
// $retdate = new Date($('input[name="returnDate"]').val());
// var loop = new Date($depdate);
// console.log($depdate);
// console.log($retdate);
// console.log(loop);
// for (var i = 0; i < availDates.length; i++) {
...
var checkoutVA = $('#dpvv2').datepicker({
    ...
    beforeShowDay: function(date) {
        ...
        return date.valueOf() > checkinVA.datepicker("getDate").valueOf();
    },
    autoclose: true

}).on('changeDate', function(ev2) {
    var startD2 = new Date(checkinVA.datepicker("getDate"));
    var endD2 = new Date(ev2.date);
    rateCalc(startD2, endD2);
    // console.log(startD2);
    // console.log(endD2);
    if (availDates.length > 0) {
        var daysOfYear = [];
        for (var d = startD2; d <= endD2; d.setDate(d.getDate() + 1)) {
            $dates = new Date(d);
            daysOfYear.push(('0' + $dates.getDate()).slice(-2) + '/' + ('0' + ($dates.getMonth() + 1)).slice(-2) + '/' + $dates.getFullYear());
        }
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (data.status) {
                ...
                $('.book-btn').attr('disabled', 'disabled');
                // alert('Villa not available for selected dates');
            }
        },
    });
...
// Datepicker for Hotels
var checkinfetH = $('#dph5').datepicker({
    format: 'dd/mm/yyyy',
    // startDate: "+0d",
    orientation: "left top",
    beforeShowDay: function(date) {
    ...
    //var minstay = parseInt($('#dmindays').val()); 
    var minstay = 2;
    var newDate = new Date(ev.date);
    var checkinDate = new Date(ev.date);
    var toDate = new Date();
    //newDate.setDate(newDate.getDate() + 1);
    newDate.setDate(newDate.getDate() + minstay);
    checkoutH.datepicker("setDate", newDate);
    checkoutsixH.datepicker("update", newDate);
    $('#dph6')[0].focus();
    $night = $("#datadiffnight").attr("data-val");
    $("#datadiff").val(minstay + " " + $night);
    $("#datadiffnight").html(minstay + " " + $night);
    var todaydiff = calculateDate(checkinDate, toDate);
    //$('#checkin_differ').val(todaydiff);
    //alert(todaydiff);
});
var checkoutsixH = $('#dph6').datepicker({
    format: 'dd/mm/yyyy',
    // startDate: "+0d",
    orientation: "left top",
    beforeShowDay: function(date) {
        return date.valueOf() > checkinfetH.datepicker("getDate").valueOf();
    },
    autoclose: true
}).on('changeDate', function(ev) {
    //focusObj($(this).closest('form').find('.travellers-input-popup'), 'show');
