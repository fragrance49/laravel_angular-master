...
class CreateHotelSearchResultTable extends Migration
{
    /**
     * Schema table name to migrate
     * @var string
     */
    public $tableName = 'hotel_search_result';

    /**
     * Run the migrations.
     * @table hotel_search_result
     *
     * @return void
     */
    public function up()
    {
        Schema::create($this->tableName, function (Blueprint $table) {
            ...
            $table->text('board_type')->nullable()->default(null);
            $table->text('hotel_crs_cancellation_json')->nullable()->default(null);
            $table->text('rate_basis_desc')->nullable()->default(null);
            ...
            $table->float('member_discount')->default('0');
            ...
            $table->longText('promotion_ota')->nullable()->default(null);
        });
    }
